...
See docs at <https://www.stedi.com/edi/x12/element/678>*/
    ...
    fn from_description(description: &str) -> Option<ShipDeliveryOrCalendarPatternCode> {
        {
            ...
            match description {
                ...
                "By Appointment Only" => Some(ByAppointmentOnly),
