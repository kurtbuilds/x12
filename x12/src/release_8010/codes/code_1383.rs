...
See docs at <https://www.stedi.com/edi/x12/element/1383>*/
...
pub enum ClaimSubmissionReasonCode {
    ...
    ///29 - Adjustment
    Adjustment,
    ///30 - Payer Reconsideration
    PayerReconsideration,
    ///31 - Jurisdictional Reconsideration
    JurisdictionalReconsideration,
    ///32 - Judicial Reconsideration
...
impl ClaimSubmissionReasonCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                LateCharges => "28",
                Adjustment => "29",
                PayerReconsideration => "30",
                JurisdictionalReconsideration => "31",
                JudicialReconsideration => "32",
    ...
    pub fn from_code(code: &[u8]) -> Option<ClaimSubmissionReasonCode> {
        ...
        match code {
            ...
            b"30" => Some(PayerReconsideration),
            b"31" => Some(JurisdictionalReconsideration),
            b"32" => Some(JudicialReconsideration),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            JurisdictionalReconsideration => "Jurisdictional Reconsideration",
            JudicialReconsideration => "Judicial Reconsideration",
    ...
    fn from_description(description: &str) -> Option<ClaimSubmissionReasonCode> {
        {
            ...
            match description {
                ...
                "Payer Reconsideration" => Some(PayerReconsideration),
                "Jurisdictional Reconsideration" => Some(JurisdictionalReconsideration),
                "Judicial Reconsideration" => Some(JudicialReconsideration),
