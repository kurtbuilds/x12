...
pub enum ReferenceIdentificationQualifier {
    ...
    TaxAdvantageAccountHealthInsurancePolicyNumber,
    ...
    ///ABY - Standard Unique Health Plan Identifier (HPID)
    CodeABY,
    ///ABZ - Employment Visa
    EmploymentVisa,
    ...
    ///ACT - Accounting Code
    AccountingCode,
    ///ACU - Permanent Resident Card C2
    PermanentResidentCardC2,
    ...
    ///AGE - Age Limits ID
    AgeLimitsId,
    ///AGG - Alternatives Groups ID
    AlternativesGroupsId,
    ///AGH - Lender Use
    LenderUse,
    ///AGI - Guarantor Use
    GuarantorUse,
    ...
    ListTracking,
    ///AGR - U.S. Alien Registration Card A1
    USAlienRegistrationCardA1,
    ///AGS - Permanent Resident Card (1998-2003) C1
    CodeAGS,
    ///AGT - Visa Non-Immigrant
    VisaNonImmigrant,
    ///AGY - Agency Disbursing Identifier Code
    AgencyDisbursingIdentifierCode,
    ///AGZ - Agency Accounting Identifier
    AgencyAccounting,
    ///AH - Agreement Number
    AgreementNumber,
    ...
    AssociatedInvoices,
    ///AID - Automated Commercial Environment (ACE) ID
    CodeAID,
    ///AIG - Active Ingredient Group Number
    ActiveIngredientGroupNumber,
    ...
    TitlePolicyNumber,
    ///ALK - Alternatives Links ID
    AlternativesLinksId,
    ///ALL - All Code Values Supported Identifier
    AllCodeValuesSupported,
    ///ALR - U.S. Alien Registration Card A2
    USAlienRegistrationCardA2,
    ///ALS - Alternative List ID
    AlternativeListId,
    ///ALT - Alteration Number
    AlterationNumber,
    ///ALV - Secure Electronic Network for Travelers Rapid Inspection (SENTRI) Card
    CodeALV,
    ///ALX - U.S. Merchant Mariner Document
    USMerchantMarinerDocument,
    ///ALY - Native American Indian/INAC (Indian and Northern Affairs Canada)
    CodeALY,
    ///AM - Adjustment Memo (Charge Back)
    CodeAM,
    ///AN - Associated Purchase Orders
    AssociatedPurchaseOrders,
    ///ANI - U.S. Customs and Border Protection (CBP) Assigned Importer Identifier
    CodeANI,
    ///ANT - Anatomical Therapeutic Chemical (ATC) Classification Code
    CodeANT,
    ...
    ///AR - Arrival Code
    ArrivalCode,
    ///ARN - Automated Broker Interface (ABI) Routing Number
    CodeARN,
    ...
    CodeATH,
    ///ATI - Alternatives Triggers ID
    AlternativesTriggersId,
    ...
    ///BCP - Laser Visa Border Crossing Card
    LaserVisaBorderCrossingCard,
    ///BD - Bid Number
    BidNumber,
    ///BDG - Badge Number
    BadgeNumber,
    ...
    BusinessActivity,
    ///BED - Downstream Service Provider's Activity Code
    DownstreamServiceProvidersActivityCode,
    ///BEN - Broker Entry Number
    BrokerEntryNumber,
    ///BET - Business Event Type Code
    BusinessEventTypeCode,
    ///BEU - Upstream Service Provider's Activity Code
    UpstreamServiceProvidersActivityCode,
    ...
    ///BIC - U.S. Customs and Border Protection (CBP) Bond Activity Reference
    CodeBIC,
    ///BIN - U.S. Customs and Border Protection (CBP) Bond Identifier
    CodeBIN,
    ///BJ - Carrier's Customs Bond Number
    CarriersCustomsBondNumber,
    ///BK - Broker's Order Number
    BrokersOrderNumber,
    ///BKD - Canada Border Service Agency (CBSA) Participant Number
    CodeBKD,
...
Identification Number*/
    ...
    CensusBlockGroup,
    ///CBI - Capacity Block ID
    CapacityBlockId,
    ///CC - Contract Co-op Number
    ContractCoOpNumber,
    ///CCD - Compounding Bases
    CompoundingBases,
    ///CCH - Compounding Chemical
    CompoundingChemical,
    ...
    ClassOfContractCode,
    ///CED - Canada Border Services Agency (CBSA) Export Declaration Number
    CodeCED,
    ///CEN - Census Exemption Number
    CensusExemptionNumber,
    ///CER - Canada Border Services Agency (CBSA) Exemption Reference ID
    CodeCER,
    ///CES - Canada Border Services Agency (CBSA) Export Summary Reporting ID
    CodeCES,
    ///CF - Fleet Reference Number
    FleetReferenceNumber,
    ///CFI - Canadian Food Inspection Agency (CFIA) Product Code
    CodeCFI,
    ...
    ///CIN - U.S. Customs and Border Protection (CBP) Assigned Consignee Identifier
    CodeCIN,
    ///CIR - Circuit Number
    CircuitNumber,
    ///CIT - Citation
    ...
    BuyersCreditMemo,
    ///CMH - Carrier or Merchant Intermodal International Haulage Identification
    CarrierOrMerchantIntermodalInternationalHaulageIdentification,
    ...
    ///CNF - Canadian Nutrient File (CNF) Health Canada Food Code
    CodeCNF,
    ...
    ///CON - Certificate of Naturalization ID
    CertificateOfNaturalizationId,
    ...
    ///CPS - Copay Product Specific ID
    CopayProductSpecificId,
    ...
    ///CSI - Copay Summary ID
    CopaySummaryId,
    ///CSK - Census Schedule K Code
    CensusScheduleKCode,
    ...
    ClearTextClause,
    ///CUB - U.S. Customs and Border Protection (CBP) Bill of Lading Number
    CodeCUB,
    ///CV - Coil Number
    CoilNumber,
    ///CVI - Code Value Identifier
    CodeValue,
    ...
    ///DE - Depositor Number
    DepositorNumber,
    ///DEA - Drug Enforcement Agency (DEA) Certificate
    CodeDEA,
    ///DEI - Data Element Identifier
    DataElement,
    ///DEL - Product Exclusion List ID
    ProductExclusionListId,
    ///DEX - Drug Exclusion
    DrugExclusion,
    ...
    ///DIP - Drug Identification Number for Homeopathic Medicine (DIN-HM)
    CodeDIP,
    ///DIS - District Number
    DistrictNumber,
    ...
    DockReceiptNumber,
    ///DRC - Dispute Resolution Corporation Number
    DisputeResolutionCorporationNumber,
    ...
    ///DTN - U.S. Department of Transportation (DOT) Tire Identification Number (TIN)
    CodeDTN,
    ...
    CodeECJ,
    ///ECN - Export Control Classification Number (ECCN)
    CodeECN,
    ...
    ///EX - Estimate Number
    EstimateNumber,
    ///EXA - Export Declaration Exemption - U.S. Territories
    ExportDeclarationExemptionUSTerritories,
    ///EXB - Export Declaration Exemption - Canada
    ExportDeclarationExemptionCanada,
    ///EXC - Export Declaration Exemption - Limited Value
    ExportDeclarationExemptionLimitedValue,
    ///EXD - Export Declaration Exemption - Technology
    ExportDeclarationExemptionTechnology,
    ///EXE - Export Declaration Exemption - Documents to Foreign Institutions
    ExportDeclarationExemptionDocumentsToForeignInstitutions,
    ///EXF - Export Declaration Exemption - Gifts and Humanitarian Donations
    ExportDeclarationExemptionGiftsAndHumanitarianDonations,
    ///EXG - Export Declaration Exemption - Diplomatic
    ExportDeclarationExemptionDiplomatic,
    ///EXH - Export Declaration Exemption - Human Remains
    ExportDeclarationExemptionHumanRemains,
    ///EXI - Export Declaration Exemption - Interplant Correspondence
    ExportDeclarationExemptionInterplantCorrespondence,
    ///EXJ - Export Declaration Exemption for Shipments Outbound - U.S. Aircraft Parts
    ExportDeclarationExemptionForShipmentsOutboundUSAircraftParts,
    ///EXK - Export Declaration Exemption - U.S. Banknotes and Securities
    ExportDeclarationExemptionUSBanknotesAndSecurities,
    ///EXL - Export Declaration Exemption - International Transaction Documents
    ExportDeclarationExemptionInternationalTransactionDocuments,
    ///EXM - Export Declaration Exemption - Technical Data
    ExportDeclarationExemptionTechnicalData,
    ///EXN - Export Declaration Exemption - Conveyances
    ExportDeclarationExemptionConveyances,
    ///EXO - Export Declaration Exemption - Postal Offices
    ExportDeclarationExemptionPostalOffices,
    ///EXP - Exposure State Code
    ExposureStateCode,
    ///EXQ - Export Declaration Exemption - Baggage
    ExportDeclarationExemptionBaggage,
    ///EXR - Export Declaration Exemption - Country Group E:1
    ExportDeclarationExemptionCountryGroupE1,
    ///EXS - Export Declaration Exemption - U.S. Armed Services
    ExportDeclarationExemptionUSArmedServices,
    ///EXT - Export Declaration Exemption - U.S. Government Materials
    ExportDeclarationExemptionUSGovernmentMaterials,
    ///EXU - Export Declaration Exemption - U.S. Government Employee Personal Goods
    ExportDeclarationExemptionUSGovernmentEmployeePersonalGoods,
    ///EXV - Export Declaration Exemption - U.S. Government Employee Commissary Goods
    ExportDeclarationExemptionUSGovernmentEmployeeCommissaryGoods,
    ///EXW - Export Declaration Exemption - Documents to U.S and Foreign Institutions
    ExportDeclarationExemptionDocumentsToUSAndForeignInstitutions,
    ...
    ///F9 - Freight Payer Reference Number
    FreightPayerReferenceNumber,
    ...
    ///FCE - Food Canning Establishment (FCE) Number
    CodeFCE,
    ///FCN - Assigned Contract Number
    AssignedContractNumber,
    ///FCR - Formulary Cross Reference
    FormularyCrossReference,
    ///FD - Filer Code Issued by Bureau of Census
    FilerCodeIssuedByBureauOfCensus,
    ///FDA - Food and Drug Administration (FDA) Registration Number
    CodeFDA,
    ///FDC - United States Department of Agriculture - FoodData Central Food Code
    UnitedStatesDepartmentOfAgricultureFoodDataCentralFoodCode,
    ...
    ///FI - File Identifier
    File,
    ///FIG - Federal Item Identification Guide
    FederalItemIdentificationGuide,
    ...
    DrugFormularyNumber,
    ///FOR - Forest Stewardship Councils Chain of Custody Certificate Number
    ForestStewardshipCouncilsChainOfCustodyCertificateNumber,
    ...
    FreightBillNumber,
    ///FRC - U.S. Customs and Border Protection (CBP) Facility Information Resource Management System (FIRMS) CODE
    CodeFRC,
    ...
    ///GDT - Global Document Type Identifier
    GlobalDocumentType,
    ...
    ///HCI - HCIdea Number
    HcIdeaNumber,
    ///HCS - Health Care Services Review Decision Reason Code
    HealthCareServicesReviewDecisionReasonCode,
    ...
    ///HP2 - Master Waybill
    MasterWaybill,
    ///HP3 - Preferred Gateway Identifier
    PreferredGateway,
    ///HP4 - Shipment Valuation
    ShipmentValuation,
    ///HPI - Standard Unique Health Identifier for Health Care Providers (NPI)
    CodeHPI,
    ...
    HarmonizedTariffScheduleOfTheUnitedStates,
    ...
    ///I9 - Pollutant
    Pollutant,
    ///I10 - ICD-10-CM (International Classification of Diseases, 10th Revision, Clinical Modification)
    CodeI10,
    ///I11 - ICD-11-CM (International Classification of Diseases, 11th Revision, Clinical Modification)
    CodeI11,
    ///IA - Internal Vendor Number
    InternalVendorNumber,
    ///IAC - Department of Defense Issuing Agency Code
    DepartmentOfDefenseIssuingAgencyCode,
    ///IB - In Bond Number
    InBondNumber,
    ///IC - Inbound-to Party
    InboundToParty,
    ///IC1 - ICCID - Integrated Card Circuit Identifier
    IccidIntegratedCardCircuit,
    ...
    CodeIMS,
    ///IMV - IMEISV - International Mobile Station Equipment Identity Software Version
    ImeisvInternationalMobileStationEquipmentIdentitySoftwareVersion,
    ///IN - Consignee's Invoice Number
    ConsigneesInvoiceNumber,
    ///INA - Drug Ingredient Reference
    DrugIngredientReference,
    ...
    ///ITN - Census Internal Transaction Number (ITN)
    CodeITN,
    ...
    ///KOS - Kosher Certification Number
    KosherCertificationNumber,
    ...
    ///LC - Lease Number
    LeaseNumber,
    ///LCN - Load Configuration Pattern Number
    LoadConfigurationPatternNumber,
    ///LD - Loan Number
    LoanNumber,
    ///LDG - Loading Group
    LoadingGroup,
    ...
    LenderEntityNumber,
    ///LEL - Locomotive Engineer License
    LocomotiveEngineerLicense,
    ...
    CodeLOI,
    ///LOP - Port of Load Location Number
    PortOfLoadLocationNumber,
    ///LOS - Loss Conditions
    LossConditions,
    ...
    ///MHC - Mexico Servicio de Administración Tributaria (SAT) Hazardous Code
    CodeMHC,
    ...
    MeterTicketNumber,
    ///MTC - Mexico Tariff Rate Code (Fracción Arancelaria)
    CodeMTC,
    ...
    ///MXC - Mexican Harmonized Alphanumeric Carrier (CAAT) Code
    CodeMXC,
    ///MXE - Mexican Export Bonded Warehouse Number
    MexicanExportBondedWarehouseNumber,
    ///MXI - Mexican Import Bonded Warehouse Number
    MexicanImportBondedWarehouseNumber,
    ...
    ///OCN - Organic Certification Number
    ...
    ///OEI - Healthcare Other Entity ID (OEID)
    CodeOEI,
    ...
    TariffSuffixNumber,
    ///OVF - Overflow Indicator Code
    OverflowIndicatorCode,
    ...
    PoolContractCode,
    ///PCI - Pharmacy Chain ID
    PharmacyChainId,
    ///PCJ - State of Jurisdiction
    StateOfJurisdiction,
    ///PCN - Protocol Number
    ProtocolNumber,
    ///PCS - ICD-10-PCS (International Classification of Diseases, 10th Revision, Procedure Coding System)
    CodePCS,
    ///PCT - ICD-11-PCS (International Classification of Diseases, 11th Revision, Procedure Coding System)
    CodePCT,
    ///PD - Promotion/Deal Number
    PromotionDealNumber,
    ///PDF - Census Post Departure Filing Number
    CensusPostDepartureFilingNumber,
    ...
    ///PLI - Department of Defense Provisioning Line Item Sequence Number
    DepartmentOfDefenseProvisioningLineItemSequenceNumber,
    ///PLN - Proposed Contract Number
    ProposedContractNumber,
    ///PM - Part Number
    PartNumber,
    ///PMA - Packaging Marking Indicator
    PackagingMarkingIndicator,
    ///PMN - Premarket Application Number
    PremarketApplicationNumber,
    ///PN - Permit Number
    PermitNumber,
    ///PNI - Pharmacy Network ID
    PharmacyNetworkId,
    ///PNL - Pharmacy Network
    PharmacyNetwork,
    ///PNN - Patent Number
    PatentNumber,
    ///PO - Purchase Order Number
    PurchaseOrderNumber,
    ///POD - Port of Destination Location Number
    PortOfDestinationLocationNumber,
    ///POL - Policy Number
    PolicyNumber,
    ...
    ///PSC - Portal Submission Code
    PortalSubmissionCode,
    ...
    ///PVS - Provisioning Control Code
    ProvisioningControlCode,
    ...
    ///RE - Release Number
    ReleaseNumber,
    ///REB - Reimbursable Code
    ReimbursableCode,
    ///REC - Related Case
    RelatedCase,
    ///REP - DHS (Department of Homeland Security) Re-entry Permit
    CodeREP,
    ...
    CodeRT,
    ///RTN - Department of Transportation Retread Tire Identification Number
    DepartmentOfTransportationRetreadTireIdentificationNumber,
    ///RTP - DHS (Department of Homeland Security) Travel Document
    CodeRTP,
    ///RU - Route Number
    RouteNumber,
    ///RV - Receiving Number
    ...
    ///SAL - Salary Step
    SalaryStep,
    ///SAN - Standard Inter-Service Agency Serial Control Number
    StandardInterServiceAgencySerialControlNumber,
    ///SAT - Sub Account
    SubAccount,
    ...
    ///SBA - Sub Allocation
    SubAllocation,
    ///SBC - Shared Benefit Class Number
    SharedBenefitClassNumber,
    ...
    CodeSCA,
    ///SCC - Security Cooperation Customer Code
    SecurityCooperationCustomerCode,
    ///SCI - Security Cooperation Implementing Agency
    SecurityCooperationImplementingAgency,
    ///SCL - Sub Class
    SubClass,
    ///SCN - Scale Number
    ScaleNumber,
    ...
    ///SF - Ship From
    ShipFrom,
    ///SFB - U.S. Customs and Border Protection (CBP) Importer Security Filing (ISF) BOND
    CodeSFB,
    ///SFT - U.S. Customs and Border Protection (CBP) Security Filing Transaction Number
    CodeSFT,
    ///SG - Savings
    Savings,
    ...
    ///SMG - Step Medication Group ID
    StepMedicationGroupId,
    ///SMI - Step Medication Triggers ID
    StepMedicationTriggersId,
    ///SML - Step Medication Links ID
    StepMedicationLinksId,
    ...
    CodeSO,
    ///SOJ - State of Claim Jurisdiction
    StateOfClaimJurisdiction,
    ///SP - Scan Line
    ScanLine,
    ///SPI - Specialty Products ID
    SpecialtyProductsId,
    ...
    ///SUP - Superceded Contract
    SupercededContract,
    ///SUQ - Related Contract
    RelatedContract,
    ...
    ///TPC - Approved Third-Party Certifier
    ApprovedThirdPartyCertifier,
    ///TPN - Transponder Number
    TransponderNumber,
    ///TPS - Temperature Recorder Serial Number
    TemperatureRecorderSerialNumber,
    ...
    CodeUCB,
    ///UCM - VICS Master Bill of Lading Number (17 Digits)
    CodeUCM,
    ...
    CodeUIC,
    ///UII - Department of Defense Unique Item Identifier
    ...
    ///ULC - United Nations Location Code (UNLOCODE) Number
    CodeULC,
    ...
    ///UNC - United Nations Standard Products and Service Code (UNSPSC)
    CodeUNC,
    ...
    ///USD - United States Department of Agriculture (USDA) Establishment Number
    CodeUSD,
    ///UT - Unit Train
    UnitTrain,
    ///UTY - Department of Defense Unique Item Identifier Type Reference Identifier
    DepartmentOfDefenseUniqueItemTypeReference,
    ///UU - Township Number
    TownshipNumber,
    ///UUI - Universal Unique Identifier (UUID)
    CodeUUI,
    ///UV - Range Number
    RangeNumber,
    ...
    ///X10 - Planning Schedule Type Code
    PlanningScheduleTypeCode,
    ///X11 - Status Report Code
    StatusReportCode,
    ///X12 - Inventory Transaction Type Code
    InventoryTransactionTypeCode,
    ///X13 - Report Type Code
    ReportTypeCode,
    ...
    ///YJ - Revenue Source
    RevenueSource,
    ///YK - Rent Payer Identification
    RentPayerIdentification,
    ...
    SellingArrangement,
    ///YQ - Minimum Royalty Payer Identification
    MinimumRoyaltyPayerIdentification,
...
impl ReferenceIdentificationQualifier {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                TricareIdentificationNumber => "1H",
                SpecialPriceAuthorizationNumber => "01H",
                Code1I => "1I",
                FacilityIdNumber => "1J",
                PayersClaimNumber => "1K",
                ...
                Provider => "A6",
                CodeA7 => "A7",
                TaxAdvantageAccountHealthInsurancePolicyNumber => "A8",
                ...
                ListTracking => "AGQ",
                USAlienRegistrationCardA1 => "AGR",
                CodeAGS => "AGS",
                VisaNonImmigrant => "AGT",
                AgencyDisbursingIdentifierCode => "AGY",
                AgencyAccounting => "AGZ",
                AgreementNumber => "AH",
                AirHandlingCode => "AHC",
                AssociatedInvoices => "AI",
                CodeAID => "AID",
                ActiveIngredientGroupNumber => "AIG",
                AssemblageIdentificationNumber => "AIN",
                ...
                AlternativesLinksId => "ALK",
                AllCodeValuesSupported => "ALL",
                USAlienRegistrationCardA2 => "ALR",
                AlternativeListId => "ALS",
                AlterationNumber => "ALT",
                CodeALV => "ALV",
                USMerchantMarinerDocument => "ALX",
                CodeALY => "ALY",
                CodeAM => "AM",
                ...
                LaserVisaBorderCrossingCard => "BCP",
                BidNumber => "BD",
                BadgeNumber => "BDG",
                BuildDirectiveNumber => "BDN",
                BusinessActivity => "BE",
                DownstreamServiceProvidersActivityCode => "BED",
                BrokerEntryNumber => "BEN",
                BusinessEventTypeCode => "BET",
                UpstreamServiceProvidersActivityCode => "BEU",
                ...
                CoverageListId => "CLI",
                BuyersCreditMemo => "CM",
                CarrierOrMerchantIntermodalInternationalHaulageIdentification => "CMH",
                ...
                CertificateOfNaturalizationId => "CON",
                ...
                DisputeResolutionCorporationNumber => "DRC",
                DrainholeNumber => "DRN",
                CodeDS => "DS",
                ...
                DepartmentOfDefenseEnterprise => "EID",
                CodeEII => "EII",
                ...
                EstimateNumber => "EX",
                ExportDeclarationExemptionUSTerritories => "EXA",
                ExportDeclarationExemptionCanada => "EXB",
                ExportDeclarationExemptionLimitedValue => "EXC",
                ExportDeclarationExemptionTechnology => "EXD",
                ExportDeclarationExemptionDocumentsToForeignInstitutions => "EXE",
                ExportDeclarationExemptionGiftsAndHumanitarianDonations => "EXF",
                ExportDeclarationExemptionDiplomatic => "EXG",
                ExportDeclarationExemptionHumanRemains => "EXH",
                ExportDeclarationExemptionInterplantCorrespondence => "EXI",
                ExportDeclarationExemptionForShipmentsOutboundUSAircraftParts => "EXJ",
                ExportDeclarationExemptionUSBanknotesAndSecurities => "EXK",
                ExportDeclarationExemptionInternationalTransactionDocuments => "EXL",
                ExportDeclarationExemptionTechnicalData => "EXM",
                ExportDeclarationExemptionConveyances => "EXN",
                ExportDeclarationExemptionPostalOffices => "EXO",
                ExposureStateCode => "EXP",
                ExportDeclarationExemptionBaggage => "EXQ",
                ExportDeclarationExemptionCountryGroupE1 => "EXR",
                ExportDeclarationExemptionUSArmedServices => "EXS",
                ExportDeclarationExemptionUSGovernmentMaterials => "EXT",
                ExportDeclarationExemptionUSGovernmentEmployeePersonalGoods => "EXU",
                ExportDeclarationExemptionUSGovernmentEmployeeCommissaryGoods => "EXV",
                ExportDeclarationExemptionDocumentsToUSAndForeignInstitutions => "EXW",
                ...
                FreightPayerReferenceNumber => "F9",
                CodeFA => "FA",
                ...
                ForestStewardshipCouncilsChainOfCustodyCertificateNumber => "FOR",
                ...
                HeatCode => "HC",
                HcIdeaNumber => "HCI",
                HealthCareServicesReviewDecisionReasonCode => "HCS",
                ...
                HouseWaybill => "HP1",
                MasterWaybill => "HP2",
                PreferredGateway => "HP3",
                ShipmentValuation => "HP4",
                CodeHPI => "HPI",
                ReinsuranceReference => "HQ",
                Horsepower => "HR",
                CodeHS => "HS",
                CodeOfFederalRegulations => "HT",
                HarmonizedTariffScheduleOfTheUnitedStates => "HTS",
                ...
                DepartmentOfDefenseIssuingAgencyCode => "IAC",
                InBondNumber => "IB",
                InboundToParty => "IC",
                IccidIntegratedCardCircuit => "IC1",
                CodeICD => "ICD",
                ...
                CodeIM => "IM",
                InternationalMobileEquipmentIdentity => "IME",
                CodeIMP => "IMP",
                CodeIMS => "IMS",
                ImeisvInternationalMobileStationEquipmentIdentitySoftwareVersion => "IMV",
                ConsigneesInvoiceNumber => "IN",
                DrugIngredientReference => "INA",
                ...
                Lockbox => "LB",
                LeaseNumber => "LC",
                LoadConfigurationPatternNumber => "LCN",
                LoanNumber => "LD",
                LoadingGroup => "LDG",
                LenderEntityNumber => "LE",
                LocomotiveEngineerLicense => "LEL",
                ...
                MagazineCode => "MD",
                MedicalDeviceClass => "MDC",
                MedicalDeviceLicenseNumber => "MDL",
                HazardousWasteManifestDocumentNumber => "MDN",
                MessageAddressOrId => "ME",
                MeidMobileEquipment => "MEI",
                ...
                CodeMXC => "MXC",
                MexicanExportBondedWarehouseNumber => "MXE",
                MexicanImportBondedWarehouseNumber => "MXI",
                ModelYearNumber => "MY",
                ...
                RateCardNumber => "NH",
                CodeNI => "NI",
                NationalItemIdentificationNumber => "NIN",
                ...
                OrganicCertificationNumber => "OCN",
                ...
                DepartmentOfDefenseProvisioningLineItemSequenceNumber => "PLI",
                ProposedContractNumber => "PLN",
                PartNumber => "PM",
                PackagingMarkingIndicator => "PMA",
                PremarketApplicationNumber => "PMN",
                PermitNumber => "PN",
                PharmacyNetworkId => "PNI",
                PharmacyNetwork => "PNL",
                PatentNumber => "PNN",
                PurchaseOrderNumber => "PO",
                PortOfDestinationLocationNumber => "POD",
                PolicyNumber => "POL",
                ...
                QuantityLimitsId => "QLI",
                QualityReviewMaterialCrib => "QM",
                StopSequenceNumber => "QN",
                QuantityNotAvailableReason => "QNA",
                ...
                CodeRT => "RT",
                DepartmentOfTransportationRetreadTireIdentificationNumber => "RTN",
                CodeRTP => "RTP",
                RouteNumber => "RU",
                ReceivingNumber => "RV",
                CodeRW => "RW",
                ...
                Salesperson => "SA",
                SalaryStep => "SAL",
                StandardInterServiceAgencySerialControlNumber => "SAN",
                SubAccount => "SAT",
                SalesRegionNumber => "SB",
                SubAllocation => "SBA",
                SharedBenefitClassNumber => "SBC",
                SuretyBondNumber => "SBN",
                ShipperCarOrderNumber => "SC",
                CodeSCA => "SCA",
                SecurityCooperationCustomerCode => "SCC",
                SecurityCooperationImplementingAgency => "SCI",
                SubClass => "SCL",
                ScaleNumber => "SCN",
                SubdayNumber => "SD",
                ...
                StepMedicationGroupId => "SMG",
                StepMedicationTriggersId => "SMI",
                StepMedicationLinksId => "SML",
                ...
                CodeSO => "SO",
                StateOfClaimJurisdiction => "SOJ",
                ScanLine => "SP",
                SpecialtyProductsId => "SPI",
                CodeSPL => "SPL",
                ...
                ApprovedThirdPartyCertifier => "TPC",
                TransponderNumber => "TPN",
                TemperatureRecorderSerialNumber => "TPS",
                ...
                CodeUIC => "UIC",
                DepartmentOfDefenseUniqueItem => "UII",
                ...
                CodeUSD => "USD",
                UnitTrain => "UT",
                DepartmentOfDefenseUniqueItemTypeReference => "UTY",
                TownshipNumber => "UU",
                CodeUUI => "UUI",
                RangeNumber => "UV",
                ...
                PlanningScheduleTypeCode => "X10",
                StatusReportCode => "X11",
                InventoryTransactionTypeCode => "X12",
                ReportTypeCode => "X13",
    ...
    pub fn from_code(code: &[u8]) -> Option<ReferenceIdentificationQualifier> {
        ...
        match code {
            ...
            b"6W" => Some(EnhancedDriversLicense),
            b"6X" => Some(Specimen),
            ...
            b"A6" => Some(Provider),
            b"A7" => Some(CodeA7),
            b"A8" => Some(TaxAdvantageAccountHealthInsurancePolicyNumber),
            ...
            b"ACU" => Some(PermanentResidentCardC2),
            ...
            b"AGC" => Some(CodeAGC),
            b"AGD" => Some(CodeAGD),
            b"AGE" => Some(AgeLimitsId),
            b"AGG" => Some(AlternativesGroupsId),
            ...
            b"AGR" => Some(USAlienRegistrationCardA1),
            b"AGS" => Some(CodeAGS),
            b"AGT" => Some(VisaNonImmigrant),
            b"AGY" => Some(AgencyDisbursingIdentifierCode),
            b"AGZ" => Some(AgencyAccounting),
            b"AH" => Some(AgreementNumber),
            b"AHC" => Some(AirHandlingCode),
            b"AI" => Some(AssociatedInvoices),
            b"AID" => Some(CodeAID),
            b"AIG" => Some(ActiveIngredientGroupNumber),
            b"AIN" => Some(AssemblageIdentificationNumber),
            ...
            b"ALK" => Some(AlternativesLinksId),
            b"ALL" => Some(AllCodeValuesSupported),
            b"ALR" => Some(USAlienRegistrationCardA2),
            b"ALS" => Some(AlternativeListId),
            b"ALT" => Some(AlterationNumber),
            b"ALV" => Some(CodeALV),
            b"ALX" => Some(USMerchantMarinerDocument),
            b"ALY" => Some(CodeALY),
            b"AM" => Some(CodeAM),
            ...
            b"BCP" => Some(LaserVisaBorderCrossingCard),
            b"BD" => Some(BidNumber),
            b"BDG" => Some(BadgeNumber),
            b"BDN" => Some(BuildDirectiveNumber),
            b"BE" => Some(BusinessActivity),
            b"BED" => Some(DownstreamServiceProvidersActivityCode),
            b"BEN" => Some(BrokerEntryNumber),
            b"BET" => Some(BusinessEventTypeCode),
            b"BEU" => Some(UpstreamServiceProvidersActivityCode),
            ...
            b"CBI" => Some(CapacityBlockId),
            b"CC" => Some(ContractCoOpNumber),
            b"CCD" => Some(CompoundingBases),
            b"CCH" => Some(CompoundingChemical),
            ...
            b"CED" => Some(CodeCED),
            b"CEN" => Some(CensusExemptionNumber),
            b"CER" => Some(CodeCER),
            b"CES" => Some(CodeCES),
            ...
            b"CMH" => Some(CarrierOrMerchantIntermodalInternationalHaulageIdentification),
            ...
            b"CNV" => Some(ConveyanceId),
            b"CO" => Some(CustomerOrderNumber),
            b"COL" => Some(CollocationIndicator),
            b"CON" => Some(CertificateOfNaturalizationId),
            ...
            b"CSI" => Some(CopaySummaryId),
            b"CSK" => Some(CensusScheduleKCode),
            ...
            b"DEA" => Some(CodeDEA),
            b"DEI" => Some(DataElement),
            b"DEL" => Some(ProductExclusionListId),
            b"DEX" => Some(DrugExclusion),
            b"DF" => Some(CodeDF),
            ...
            b"DID" => Some(Discount),
            b"DIN" => Some(DrugIdentificationNumber),
            b"DIP" => Some(CodeDIP),
            ...
            b"DRC" => Some(DisputeResolutionCorporationNumber),
            ...
            b"EID" => Some(DepartmentOfDefenseEnterprise),
            b"EII" => Some(CodeEII),
            ...
            b"EXA" => Some(ExportDeclarationExemptionUSTerritories),
            b"EXB" => Some(ExportDeclarationExemptionCanada),
            b"EXC" => Some(ExportDeclarationExemptionLimitedValue),
            b"EXD" => Some(ExportDeclarationExemptionTechnology),
            b"EXE" => Some(ExportDeclarationExemptionDocumentsToForeignInstitutions),
            b"EXF" => Some(ExportDeclarationExemptionGiftsAndHumanitarianDonations),
            b"EXG" => Some(ExportDeclarationExemptionDiplomatic),
            b"EXH" => Some(ExportDeclarationExemptionHumanRemains),
            b"EXI" => Some(ExportDeclarationExemptionInterplantCorrespondence),
            b"EXJ" => Some(ExportDeclarationExemptionForShipmentsOutboundUSAircraftParts),
            b"EXK" => Some(ExportDeclarationExemptionUSBanknotesAndSecurities),
            b"EXL" => Some(ExportDeclarationExemptionInternationalTransactionDocuments),
            b"EXM" => Some(ExportDeclarationExemptionTechnicalData),
            b"EXN" => Some(ExportDeclarationExemptionConveyances),
            b"EXO" => Some(ExportDeclarationExemptionPostalOffices),
            b"EXP" => Some(ExposureStateCode),
            b"EXQ" => Some(ExportDeclarationExemptionBaggage),
            b"EXR" => Some(ExportDeclarationExemptionCountryGroupE1),
            b"EXS" => Some(ExportDeclarationExemptionUSArmedServices),
            b"EXT" => Some(ExportDeclarationExemptionUSGovernmentMaterials),
            b"EXU" => Some(ExportDeclarationExemptionUSGovernmentEmployeePersonalGoods),
            b"EXV" => Some(ExportDeclarationExemptionUSGovernmentEmployeeCommissaryGoods),
            b"EXW" => Some(ExportDeclarationExemptionDocumentsToUSAndForeignInstitutions),
            ...
            b"F9" => Some(FreightPayerReferenceNumber),
            b"FA" => Some(CodeFA),
            ...
            b"FOR" => Some(ForestStewardshipCouncilsChainOfCustodyCertificateNumber),
            ...
            b"GLI" => Some(GenderLimitsId),
            b"GM" => Some(LoanAcquisitionNumber),
            b"GMI" => Some(GeneralMessageId),
            ...
            b"HB" => Some(CodeHB),
            b"HC" => Some(HeatCode),
            b"HCI" => Some(HcIdeaNumber),
            b"HCS" => Some(HealthCareServicesReviewDecisionReasonCode),
            ...
            b"HP" => Some(CodeHP),
            b"HP1" => Some(HouseWaybill),
            b"HP2" => Some(MasterWaybill),
            b"HP3" => Some(PreferredGateway),
            b"HP4" => Some(ShipmentValuation),
            b"HPI" => Some(CodeHPI),
            b"HQ" => Some(ReinsuranceReference),
            b"HR" => Some(Horsepower),
            b"HS" => Some(CodeHS),
            b"HT" => Some(CodeOfFederalRegulations),
            b"HTS" => Some(HarmonizedTariffScheduleOfTheUnitedStates),
            ...
            b"IAC" => Some(DepartmentOfDefenseIssuingAgencyCode),
            b"IB" => Some(InBondNumber),
            b"IC" => Some(InboundToParty),
            b"IC1" => Some(IccidIntegratedCardCircuit),
            b"ICD" => Some(CodeICD),
            ...
            b"IGR" => Some(IngredientReference),
            ...
            b"IM" => Some(CodeIM),
            b"IME" => Some(InternationalMobileEquipmentIdentity),
            b"IMP" => Some(CodeIMP),
            b"IMS" => Some(CodeIMS),
            b"IMV" => {
                Some(ImeisvInternationalMobileStationEquipmentIdentitySoftwareVersion)
            }
            b"IN" => Some(ConsigneesInvoiceNumber),
            b"INA" => Some(DrugIngredientReference),
            ...
            b"KOS" => Some(KosherCertificationNumber),
            ...
            b"LCN" => Some(LoadConfigurationPatternNumber),
            b"LD" => Some(LoanNumber),
            b"LDG" => Some(LoadingGroup),
            b"LE" => Some(LenderEntityNumber),
            b"LEL" => Some(LocomotiveEngineerLicense),
            ...
            b"LOI" => Some(CodeLOI),
            b"LOP" => Some(PortOfLoadLocationNumber),
            ...
            b"MDC" => Some(MedicalDeviceClass),
            b"MDL" => Some(MedicalDeviceLicenseNumber),
            b"MDN" => Some(HazardousWasteManifestDocumentNumber),
            b"ME" => Some(MessageAddressOrId),
            b"MEI" => Some(MeidMobileEquipment),
            ...
            b"MXC" => Some(CodeMXC),
            b"MXE" => Some(MexicanExportBondedWarehouseNumber),
            b"MXI" => Some(MexicanImportBondedWarehouseNumber),
            ...
            b"NI" => Some(CodeNI),
            b"NIN" => Some(NationalItemIdentificationNumber),
            ...
            b"NPN" => Some(NaturalProductNumber),
            ...
            b"OCN" => Some(OrganicCertificationNumber),
            ...
            b"OVF" => Some(OverflowIndicatorCode),
            ...
            b"PAI" => Some(PriorAuthorizationId),
            ...
            b"PLI" => Some(DepartmentOfDefenseProvisioningLineItemSequenceNumber),
            b"PLN" => Some(ProposedContractNumber),
            b"PM" => Some(PartNumber),
            b"PMA" => Some(PackagingMarkingIndicator),
            b"PMN" => Some(PremarketApplicationNumber),
            b"PN" => Some(PermitNumber),
            b"PNI" => Some(PharmacyNetworkId),
            b"PNL" => Some(PharmacyNetwork),
            b"PNN" => Some(PatentNumber),
            b"PO" => Some(PurchaseOrderNumber),
            b"POD" => Some(PortOfDestinationLocationNumber),
            ...
            b"PSC" => Some(PortalSubmissionCode),
            ...
            b"PVS" => Some(ProvisioningControlCode),
            ...
            b"QLI" => Some(QuantityLimitsId),
            b"QM" => Some(QualityReviewMaterialCrib),
            b"QN" => Some(StopSequenceNumber),
            b"QNA" => Some(QuantityNotAvailableReason),
            ...
            b"RT" => Some(CodeRT),
            b"RTN" => Some(DepartmentOfTransportationRetreadTireIdentificationNumber),
            b"RTP" => Some(CodeRTP),
            ...
            b"SAN" => Some(StandardInterServiceAgencySerialControlNumber),
            b"SAT" => Some(SubAccount),
            b"SB" => Some(SalesRegionNumber),
            b"SBA" => Some(SubAllocation),
            b"SBC" => Some(SharedBenefitClassNumber),
            b"SBN" => Some(SuretyBondNumber),
            b"SC" => Some(ShipperCarOrderNumber),
            b"SCA" => Some(CodeSCA),
            b"SCC" => Some(SecurityCooperationCustomerCode),
            b"SCI" => Some(SecurityCooperationImplementingAgency),
            b"SCL" => Some(SubClass),
            ...
            b"SMG" => Some(StepMedicationGroupId),
            b"SMI" => Some(StepMedicationTriggersId),
            b"SML" => Some(StepMedicationLinksId),
            ...
            b"SO" => Some(CodeSO),
            b"SOJ" => Some(StateOfClaimJurisdiction),
            b"SP" => Some(ScanLine),
            b"SPI" => Some(SpecialtyProductsId),
            b"SPL" => Some(CodeSPL),
            b"SPN" => Some(TheaterScreenNumber),
            b"SPP" => Some(ParentContract),
            ...
            b"SUP" => Some(SupercededContract),
            b"SUQ" => Some(RelatedContract),
            ...
            b"TPC" => Some(ApprovedThirdPartyCertifier),
            b"TPN" => Some(TransponderNumber),
            b"TPS" => Some(TemperatureRecorderSerialNumber),
            b"TQ" => Some(TracerActionRequestNumber),
            b"TR" => Some(GovernmentTransportationRequest),
            b"TRC" => Some(TransferCarrier),
            ...
            b"UIC" => Some(CodeUIC),
            b"UII" => Some(DepartmentOfDefenseUniqueItem),
            ...
            b"USD" => Some(CodeUSD),
            b"UT" => Some(UnitTrain),
            b"UTY" => Some(DepartmentOfDefenseUniqueItemTypeReference),
            ...
            b"WPN" => Some(WasteDisposalNumber),
            ...
            b"X10" => Some(PlanningScheduleTypeCode),
            b"X11" => Some(StatusReportCode),
            b"X12" => Some(InventoryTransactionTypeCode),
            b"X13" => Some(ReportTypeCode),
            ...
            b"YK" => Some(RentPayerIdentification),
            ...
            b"YQ" => Some(MinimumRoyaltyPayerIdentification),
            ...
            b"ZF" => Some(ResidueIndicatorCode),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            TricareIdentificationNumber => "TRICARE Identification Number",
            ...
            PayersClaimNumber => "Payer's Claim Number",
            ...
            Code3R => "U.S. Customs and Border Protection (CBP) Binding Ruling Number",
            ...
            Code3W => "U.S. Customs and Border Protection (CBP) Commercial Description",
            ...
            Code6B => "U.S. Customs and Border Protection (CBP) Entry Number",
            Code6C => "U.S. Customs and Border Protection (CBP) Entry Type Code",
            Code6D => "U.S. Customs and Border Protection (CBP) Statement Number",
            ...
            EnhancedDriversLicense => "Enhanced Driver's License",
            ...
            CodeABY => "Standard Unique Health Plan Identifier (HPID)",
            ...
            PermanentResidentCardC2 => "Permanent Resident Card C2",
            ...
            AgeLimitsId => "Age Limits ID",
            AlternativesGroupsId => "Alternatives Groups ID",
            ...
            USAlienRegistrationCardA1 => "U.S. Alien Registration Card A1",
            CodeAGS => "Permanent Resident Card (1998-2003) C1",
            VisaNonImmigrant => "Visa Non-Immigrant",
            AgencyDisbursingIdentifierCode => "Agency Disbursing Identifier Code",
            AgencyAccounting => "Agency Accounting Identifier",
            AgreementNumber => "Agreement Number",
            AirHandlingCode => "Air Handling Code",
            AssociatedInvoices => "Associated Invoices",
            CodeAID => "Automated Commercial Environment (ACE) ID",
            ActiveIngredientGroupNumber => "Active Ingredient Group Number",
            ...
            AlternativesLinksId => "Alternatives Links ID",
            AllCodeValuesSupported => "All Code Values Supported Identifier",
            USAlienRegistrationCardA2 => "U.S. Alien Registration Card A2",
            ...
            USMerchantMarinerDocument => "U.S. Merchant Mariner Document",
            CodeALY => "Native American Indian/INAC (Indian and Northern Affairs Canada)",
            ...
            CodeANT => "Anatomical Therapeutic Chemical (ATC) Classification Code",
            ...
            CodeARN => "Automated Broker Interface (ABI) Routing Number",
            ...
            CodeATH => "American Hospital Formulary System (AHFS) Classification Code",
            AlternativesTriggersId => "Alternatives Triggers ID",
            AuthorizationToMeetCompetitionNumber => {
            ...
            LaserVisaBorderCrossingCard => "Laser Visa Border Crossing Card",
            BidNumber => "Bid Number",
            BadgeNumber => "Badge Number",
            BuildDirectiveNumber => "Build Directive Number",
            BusinessActivity => "Business Activity",
            DownstreamServiceProvidersActivityCode => {
                "Downstream Service Provider's Activity Code"
            }
            BrokerEntryNumber => "Broker Entry Number",
            BusinessEventTypeCode => "Business Event Type Code",
            UpstreamServiceProvidersActivityCode => {
                "Upstream Service Provider's Activity Code"
            }
            ...
            CodeBIC => "U.S. Customs and Border Protection (CBP) Bond Activity Reference",
            CodeBIN => "U.S. Customs and Border Protection (CBP) Bond Identifier",
            CarriersCustomsBondNumber => "Carrier's Customs Bond Number",
            BrokersOrderNumber => "Broker's Order Number",
            CodeBKD => "Canada Border Service Agency (CBSA) Participant Number",
            ...
            CapacityBlockId => "Capacity Block ID",
            ContractCoOpNumber => "Contract Co-op Number",
            CompoundingBases => "Compounding Bases",
            CompoundingChemical => "Compounding Chemical",
            ...
            CodeCED => "Canada Border Services Agency (CBSA) Export Declaration Number",
            CensusExemptionNumber => "Census Exemption Number",
            CodeCER => "Canada Border Services Agency (CBSA) Exemption Reference ID",
            CodeCES => "Canada Border Services Agency (CBSA) Export Summary Reporting ID",
            FleetReferenceNumber => "Fleet Reference Number",
            CodeCFI => "Canadian Food Inspection Agency (CFIA) Product Code",
            ...
            CarrierOrMerchantIntermodalInternationalHaulageIdentification => {
                "Carrier or Merchant Intermodal International Haulage Identification"
            }
            ...
            CodeCNF => "Canadian Nutrient File (CNF) Health Canada Food Code",
            ...
            CertificateOfNaturalizationId => "Certificate of Naturalization ID",
            ...
            CopayProductSpecificId => "Copay Product Specific ID",
            ...
            CrossReferenceId => "Cross Reference ID",
            ...
            CopaySummaryId => "Copay Summary ID",
            CensusScheduleKCode => "Census Schedule K Code",
            CensusStateCode => "Census State Code",
            ContractNumber => "Contract Number",
            CensusTractSuffix => "Census Tract Suffix",
            ClearTextClause => "Clear Text Clause",
            CodeCUB => "U.S. Customs and Border Protection (CBP) Bill of Lading Number",
            CoilNumber => "Coil Number",
            CodeValue => "Code Value Identifier",
            CommercialVehicleSafetyAssuranceNumber => {
            ...
            CodeDEA => "Drug Enforcement Agency (DEA) Certificate",
            DataElement => "Data Element Identifier",
            ProductExclusionListId => "Product Exclusion List ID",
            DrugExclusion => "Drug Exclusion",
            ...
            CodeDIP => "Drug Identification Number for Homeopathic Medicine (DIN-HM)",
            ...
            DisputeResolutionCorporationNumber => "Dispute Resolution Corporation Number",
            ...
            CodeDTN => {
                "U.S. Department of Transportation (DOT) Tire Identification Number (TIN)"
            }
            CodeDTS => {
            ...
            CodeECN => "Export Control Classification Number (ECCN)",
            ...
            ExportDeclarationExemptionUSTerritories => {
                "Export Declaration Exemption - U.S. Territories"
            }
            ExportDeclarationExemptionCanada => "Export Declaration Exemption - Canada",
            ExportDeclarationExemptionLimitedValue => {
                "Export Declaration Exemption - Limited Value"
            }
            ExportDeclarationExemptionTechnology => {
                "Export Declaration Exemption - Technology"
            }
            ExportDeclarationExemptionDocumentsToForeignInstitutions => {
                "Export Declaration Exemption - Documents to Foreign Institutions"
            }
            ExportDeclarationExemptionGiftsAndHumanitarianDonations => {
                "Export Declaration Exemption - Gifts and Humanitarian Donations"
            }
            ExportDeclarationExemptionDiplomatic => {
                "Export Declaration Exemption - Diplomatic"
            }
            ExportDeclarationExemptionHumanRemains => {
                "Export Declaration Exemption - Human Remains"
            }
            ExportDeclarationExemptionInterplantCorrespondence => {
                "Export Declaration Exemption - Interplant Correspondence"
            }
            ExportDeclarationExemptionForShipmentsOutboundUSAircraftParts => {
                "Export Declaration Exemption for Shipments Outbound - U.S. Aircraft Parts"
            }
            ExportDeclarationExemptionUSBanknotesAndSecurities => {
                "Export Declaration Exemption - U.S. Banknotes and Securities"
            }
            ExportDeclarationExemptionInternationalTransactionDocuments => {
                "Export Declaration Exemption - International Transaction Documents"
            }
            ExportDeclarationExemptionTechnicalData => {
                "Export Declaration Exemption - Technical Data"
            }
            ExportDeclarationExemptionConveyances => {
                "Export Declaration Exemption - Conveyances"
            }
            ExportDeclarationExemptionPostalOffices => {
                "Export Declaration Exemption - Postal Offices"
            }
            ExposureStateCode => "Exposure State Code",
            ExportDeclarationExemptionBaggage => "Export Declaration Exemption - Baggage",
            ExportDeclarationExemptionCountryGroupE1 => {
                "Export Declaration Exemption - Country Group E:1"
            }
            ExportDeclarationExemptionUSArmedServices => {
                "Export Declaration Exemption - U.S. Armed Services"
            }
            ExportDeclarationExemptionUSGovernmentMaterials => {
                "Export Declaration Exemption - U.S. Government Materials"
            }
            ExportDeclarationExemptionUSGovernmentEmployeePersonalGoods => {
            ...
            FreightPayerReferenceNumber => "Freight Payer Reference Number",
            ...
            CodeFCE => "Food Canning Establishment (FCE) Number",
            AssignedContractNumber => "Assigned Contract Number",
            FormularyCrossReference => "Formulary Cross Reference",
            FilerCodeIssuedByBureauOfCensus => "Filer Code Issued by Bureau of Census",
            CodeFDA => "Food and Drug Administration (FDA) Registration Number",
            UnitedStatesDepartmentOfAgricultureFoodDataCentralFoodCode => {
                "United States Department of Agriculture - FoodData Central Food Code"
            }
            FailureMechanismNumber => "Failure mechanism number",
            ForeignEntryNumber => "Foreign Entry Number",
            FilmNumber => "Film Number",
            FederalFirearmsLicense => "Federal Firearms License",
            ...
            FederalItemIdentificationGuide => "Federal Item Identification Guide",
            ...
            ForestStewardshipCouncilsChainOfCustodyCertificateNumber => {
                "Forest Stewardship Councils Chain of Custody Certificate Number"
            }
            ...
            GlobalDocumentType => "Global Document Type Identifier",
            ...
            GenderLimitsId => "Gender Limits ID",
            LoanAcquisitionNumber => "Loan Acquisition Number",
            GeneralMessageId => "General Message ID",
            ...
            HealthCareServicesReviewDecisionReasonCode => {
                "Health Care Services Review Decision Reason Code"
            }
            DepartmentOfTransportationHazardousNumber => {
            ...
            PreferredGateway => "Preferred Gateway Identifier",
            ShipmentValuation => "Shipment Valuation",
            CodeHPI => {
            ...
            IccidIntegratedCardCircuit => "ICCID - Integrated Card Circuit Identifier",
            CodeICD => {
            ...
            DrugIngredientReference => "Drug Ingredient Reference",
            ...
            CodeITN => "Census Internal Transaction Number (ITN)",
            ...
            KosherCertificationNumber => "Kosher Certification Number",
            ...
            LoadConfigurationPatternNumber => "Load Configuration Pattern Number",
            LoanNumber => "Loan Number",
            LoadingGroup => "Loading Group",
            LenderEntityNumber => "Lender Entity Number",
            LocomotiveEngineerLicense => "Locomotive Engineer License",
            ...
            PortOfLoadLocationNumber => "Port of Load Location Number",
            ...
            CodeMTC => "Mexico Tariff Rate Code (Fracción Arancelaria)",
            ...
            CodeMXC => "Mexican Harmonized Alphanumeric Carrier (CAAT) Code",
            MexicanExportBondedWarehouseNumber => {
                "Mexican Export Bonded Warehouse Number"
            }
            MexicanImportBondedWarehouseNumber => {
                "Mexican Import Bonded Warehouse Number"
            }
            ...
            NaturalProductNumber => "Natural Product Number",
            MedicaidRecipientIdentificationNumber => {
            ...
            OverflowIndicatorCode => "Overflow Indicator Code",
            ...
            PriorAuthorizationId => "Prior Authorization ID",
            NonprovisionalPatentApplicationNumber => {
            ...
            PharmacyChainId => "Pharmacy Chain ID",
            ...
            CensusPostDepartureFilingNumber => "Census Post Departure Filing Number",
            ...
            ProductExclusionId => "Product Exclusion ID",
            ...
            DepartmentOfDefenseProvisioningLineItemSequenceNumber => {
                "Department of Defense Provisioning Line Item Sequence Number"
            }
            ProposedContractNumber => "Proposed Contract Number",
            PartNumber => "Part Number",
            PackagingMarkingIndicator => "Packaging Marking Indicator",
            PremarketApplicationNumber => "Premarket Application Number",
            PermitNumber => "Permit Number",
            PharmacyNetworkId => "Pharmacy Network ID",
            PharmacyNetwork => "Pharmacy Network",
            PatentNumber => "Patent Number",
            PurchaseOrderNumber => "Purchase Order Number",
            PortOfDestinationLocationNumber => "Port of Destination Location Number",
            ...
            PortalSubmissionCode => "Portal Submission Code",
            PreviousShipmentIdentificationNumberContinuousMove => {
            ...
            ProvisioningControlCode => "Provisioning Control Code",
            ...
            ReimbursableCode => "Reimbursable Code",
            RelatedCase => "Related Case",
            CodeREP => "DHS (Department of Homeland Security) Re-entry Permit",
            ...
            CodeRRB => "Railroad Board (RRB) Number",
            ...
            DepartmentOfTransportationRetreadTireIdentificationNumber => {
                "Department of Transportation Retread Tire Identification Number"
            }
            CodeRTP => "DHS (Department of Homeland Security) Travel Document",
            ...
            StandardInterServiceAgencySerialControlNumber => {
                "Standard Inter-Service Agency Serial Control Number"
            }
            SubAccount => "Sub Account",
            SalesRegionNumber => "Sales Region Number",
            SubAllocation => "Sub Allocation",
            SharedBenefitClassNumber => "Shared Benefit Class Number",
            ...
            SecurityCooperationCustomerCode => "Security Cooperation Customer Code",
            SecurityCooperationImplementingAgency => {
            ...
            StepMedicationGroupId => "Step Medication Group ID",
            StepMedicationTriggersId => "Step Medication Triggers ID",
            StepMedicationLinksId => "Step Medication Links ID",
            StateOfMassachusettsTownCode => "State of Massachusetts Town Code",
            SealNumber => "Seal Number",
            CodeSNH => "SNOMED, Systematized Nomenclature of Medicine",
            CodeSNP => "U.S. Customs & Border Protection (CBP) Second Notify Party",
            StateNonResidentViolatorCompact => "State Non-Resident Violator Compact",
            CodeSO => "Shipper's Order (Invoice Number)",
            StateOfClaimJurisdiction => "State of Claim Jurisdiction",
            ScanLine => "Scan Line",
            SpecialtyProductsId => "Specialty Products ID",
            ...
            SupercededContract => "Superceded Contract",
            ...
            ApprovedThirdPartyCertifier => "Approved Third-Party Certifier",
            TransponderNumber => "Transponder Number",
            TemperatureRecorderSerialNumber => "Temperature Recorder Serial Number",
            TracerActionRequestNumber => "Tracer Action Request Number",
            GovernmentTransportationRequest => "Government Transportation Request",
            TransferCarrier => "Transfer Carrier",
            ...
            CodeUCB => "VICS Bill of Lading Number (17 Digits)",
            CodeUCM => "VICS Master Bill of Lading Number (17 Digits)",
            ...
            CodeULC => "United Nations Location Code (UNLOCODE) Number",
            QuarterQuarterSectionNumber => "Quarter Quarter Section Number",
            UnitedNationsHazardousClassificationNumber => {
                "United Nations Hazardous Classification Number"
            }
            CodeUNC => "United Nations Standard Products and Service Code (UNSPSC)",
            ...
            UniformResource => "Uniform Resource Identifier",
            ...
            CodeUUI => "Universal Unique Identifier (UUID)",
            ...
            WasteDisposalNumber => "Waste Disposal Number",
            InterimFundingOrganizationLoanNumber => {
            ...
            PlanningScheduleTypeCode => "Planning Schedule Type Code",
            StatusReportCode => "Status Report Code",
            InventoryTransactionTypeCode => "Inventory Transaction Type Code",
            ReportTypeCode => "Report Type Code",
            ...
            RentPayerIdentification => "Rent Payer Identification",
            ...
            MinimumRoyaltyPayerIdentification => "Minimum Royalty Payer Identification",
            ...
            ResidueIndicatorCode => "Residue Indicator Code",
    ...
    fn from_description(description: &str) -> Option<ReferenceIdentificationQualifier> {
        {
            ...
            match description {
                ...
                "Linking Identifier" => Some(Linking),
                ...
                "TRICARE Identification Number" => Some(TricareIdentificationNumber),
                ...
                "Payer's Claim Number" => Some(PayersClaimNumber),
                ...
                "U.S. Customs and Border Protection (CBP) Binding Ruling Number" => {
                    Some(Code3R)
                }
                ...
                "U.S. Customs and Border Protection (CBP) Commercial Description" => {
                    Some(Code3W)
                }
                ...
                "U.S. Customs and Border Protection (CBP) Entry Number" => Some(Code6B),
                "U.S. Customs and Border Protection (CBP) Entry Type Code" => {
                    Some(Code6C)
                }
                "U.S. Customs and Border Protection (CBP) Statement Number" => {
                    Some(Code6D)
                }
                ...
                "Enhanced Driver's License" => Some(EnhancedDriversLicense),
                ...
                "Visa Immigrant" => Some(VisaImmigrant),
                ...
                "Provider Identifier" => Some(Provider),
                "Flexible Spending Account (FSA) Insurance Account Number" => {
                    Some(CodeA7)
                }
                "Tax Advantage Account Health Insurance Policy Number" => {
                    Some(TaxAdvantageAccountHealthInsurancePolicyNumber)
                }
                ...
                "Standard Unique Health Plan Identifier (HPID)" => Some(CodeABY),
                ...
                "Permanent Resident Card C2" => Some(PermanentResidentCardC2),
                ...
                "U.S. Passport Card" => Some(USPassportCard),
                ...
                "Age Limits ID" => Some(AgeLimitsId),
                "Alternatives Groups ID" => Some(AlternativesGroupsId),
                ...
                "U.S. Alien Registration Card A1" => Some(USAlienRegistrationCardA1),
                "Permanent Resident Card (1998-2003) C1" => Some(CodeAGS),
                "Visa Non-Immigrant" => Some(VisaNonImmigrant),
                "Agency Disbursing Identifier Code" => {
                    Some(AgencyDisbursingIdentifierCode)
                }
                "Agency Accounting Identifier" => Some(AgencyAccounting),
                "Agreement Number" => Some(AgreementNumber),
                "Air Handling Code" => Some(AirHandlingCode),
                "Associated Invoices" => Some(AssociatedInvoices),
                "Automated Commercial Environment (ACE) ID" => Some(CodeAID),
                "Active Ingredient Group Number" => Some(ActiveIngredientGroupNumber),
                ...
                "Alternatives Links ID" => Some(AlternativesLinksId),
                "All Code Values Supported Identifier" => Some(AllCodeValuesSupported),
                "U.S. Alien Registration Card A2" => Some(USAlienRegistrationCardA2),
                "Alternative List ID" => Some(AlternativeListId),
                "Alteration Number" => Some(AlterationNumber),
                "Secure Electronic Network for Travelers Rapid Inspection (SENTRI) Card" => {
                    Some(CodeALV)
                }
                "U.S. Merchant Mariner Document" => Some(USMerchantMarinerDocument),
                "Native American Indian/INAC (Indian and Northern Affairs Canada)" => {
                    Some(CodeALY)
                }
                ...
                "Automated Broker Interface (ABI) Routing Number" => Some(CodeARN),
                ...
                "American Hospital Formulary System (AHFS) Classification Code" => {
                    Some(CodeATH)
                }
                "Alternatives Triggers ID" => Some(AlternativesTriggersId),
                "Authorization to Meet Competition Number" => {
                ...
                "Availability Type" => Some(AvailabilityType),
                ...
                "Laser Visa Border Crossing Card" => Some(LaserVisaBorderCrossingCard),
                ...
                "Downstream Service Provider's Activity Code" => {
                    Some(DownstreamServiceProvidersActivityCode)
                }
                "Broker Entry Number" => Some(BrokerEntryNumber),
                "Business Event Type Code" => Some(BusinessEventTypeCode),
                "Upstream Service Provider's Activity Code" => {
                    Some(UpstreamServiceProvidersActivityCode)
                }
                ...
                "U.S. Customs and Border Protection (CBP) Bond Activity Reference" => {
                    Some(CodeBIC)
                }
                "U.S. Customs and Border Protection (CBP) Bond Identifier" => {
                    Some(CodeBIN)
                }
                "Carrier's Customs Bond Number" => Some(CarriersCustomsBondNumber),
                "Broker's Order Number" => Some(BrokersOrderNumber),
                "Canada Border Service Agency (CBSA) Participant Number" => Some(CodeBKD),
                "Bank Telegraphic Number" => Some(BankTelegraphicNumber),
                "Government Bill of Lading" => Some(GovernmentBillOfLading),
                "Budget Line Item" => Some(BudgetLineItem),
                ...
                "Capacity Block ID" => Some(CapacityBlockId),
                "Contract Co-op Number" => Some(ContractCoOpNumber),
                "Compounding Bases" => Some(CompoundingBases),
                "Compounding Chemical" => Some(CompoundingChemical),
                ...
                "Census Exemption Number" => Some(CensusExemptionNumber),
                "Canada Border Services Agency (CBSA) Exemption Reference ID" => {
                    Some(CodeCER)
                }
                "Canada Border Services Agency (CBSA) Export Summary Reporting ID" => {
                    Some(CodeCES)
                }
                "Fleet Reference Number" => Some(FleetReferenceNumber),
                "Canadian Food Inspection Agency (CFIA) Product Code" => Some(CodeCFI),
                ...
                "Carrier or Merchant Intermodal International Haulage Identification" => {
                    Some(CarrierOrMerchantIntermodalInternationalHaulageIdentification)
                }
                ...
                "Copay Product Specific ID" => Some(CopayProductSpecificId),
                ...
                "Cross Reference ID" => Some(CrossReferenceId),
                ...
                "Copay Summary ID" => Some(CopaySummaryId),
                "Census Schedule K Code" => Some(CensusScheduleKCode),
                ...
                "U.S. Customs and Border Protection (CBP) Bill of Lading Number" => {
                    Some(CodeCUB)
                }
                "Coil Number" => Some(CoilNumber),
                "Code Value Identifier" => Some(CodeValue),
                "Commercial Vehicle Safety Assurance Number" => {
                ...
                "Cycle Indicator" => Some(CycleIndicator),
                ...
                "Drug Enforcement Agency (DEA) Certificate" => Some(CodeDEA),
                "Data Element Identifier" => Some(DataElement),
                "Product Exclusion List ID" => Some(ProductExclusionListId),
                "Drug Exclusion" => Some(DrugExclusion),
                ...
                "Discount Identifier" => Some(Discount),
                "Drug Identification Number" => Some(DrugIdentificationNumber),
                ...
                "Dispute Resolution Corporation Number" => {
                    Some(DisputeResolutionCorporationNumber)
                }
                ...
                "Export Control Classification Number (ECCN)" => Some(CodeECN),
                ...
                "Tag Serial Number" => Some(TagSerialNumber),
                ...
                "Export Declaration Exemption - U.S. Territories" => {
                    Some(ExportDeclarationExemptionUSTerritories)
                }
                "Export Declaration Exemption - Canada" => {
                    Some(ExportDeclarationExemptionCanada)
                }
                "Export Declaration Exemption - Limited Value" => {
                    Some(ExportDeclarationExemptionLimitedValue)
                }
                "Export Declaration Exemption - Technology" => {
                    Some(ExportDeclarationExemptionTechnology)
                }
                "Export Declaration Exemption - Documents to Foreign Institutions" => {
                    Some(ExportDeclarationExemptionDocumentsToForeignInstitutions)
                }
                "Export Declaration Exemption - Gifts and Humanitarian Donations" => {
                    Some(ExportDeclarationExemptionGiftsAndHumanitarianDonations)
                }
                "Export Declaration Exemption - Diplomatic" => {
                    Some(ExportDeclarationExemptionDiplomatic)
                }
                "Export Declaration Exemption - Human Remains" => {
                    Some(ExportDeclarationExemptionHumanRemains)
                }
                "Export Declaration Exemption - Interplant Correspondence" => {
                    Some(ExportDeclarationExemptionInterplantCorrespondence)
                }
                "Export Declaration Exemption for Shipments Outbound - U.S. Aircraft Parts" => {
                    Some(ExportDeclarationExemptionForShipmentsOutboundUSAircraftParts)
                }
                "Export Declaration Exemption - U.S. Banknotes and Securities" => {
                    Some(ExportDeclarationExemptionUSBanknotesAndSecurities)
                }
                "Export Declaration Exemption - International Transaction Documents" => {
                    Some(ExportDeclarationExemptionInternationalTransactionDocuments)
                }
                "Export Declaration Exemption - Technical Data" => {
                    Some(ExportDeclarationExemptionTechnicalData)
                }
                "Export Declaration Exemption - Conveyances" => {
                    Some(ExportDeclarationExemptionConveyances)
                }
                "Export Declaration Exemption - Postal Offices" => {
                    Some(ExportDeclarationExemptionPostalOffices)
                }
                "Exposure State Code" => Some(ExposureStateCode),
                "Export Declaration Exemption - Baggage" => {
                    Some(ExportDeclarationExemptionBaggage)
                }
                "Export Declaration Exemption - Country Group E:1" => {
                    Some(ExportDeclarationExemptionCountryGroupE1)
                }
                "Export Declaration Exemption - U.S. Armed Services" => {
                    Some(ExportDeclarationExemptionUSArmedServices)
                }
                "Export Declaration Exemption - U.S. Government Materials" => {
                    Some(ExportDeclarationExemptionUSGovernmentMaterials)
                }
                "Export Declaration Exemption - U.S. Government Employee Personal Goods" => {
                    Some(ExportDeclarationExemptionUSGovernmentEmployeePersonalGoods)
                }
                "Export Declaration Exemption - U.S. Government Employee Commissary Goods" => {
                    Some(ExportDeclarationExemptionUSGovernmentEmployeeCommissaryGoods)
                }
                "Export Declaration Exemption - Documents to U.S and Foreign Institutions" => {
                    Some(ExportDeclarationExemptionDocumentsToUSAndForeignInstitutions)
                }
                ...
                "Freight Payer Reference Number" => Some(FreightPayerReferenceNumber),
                ...
                "Food Canning Establishment (FCE) Number" => Some(CodeFCE),
                "Assigned Contract Number" => Some(AssignedContractNumber),
                "Formulary Cross Reference" => Some(FormularyCrossReference),
                "Filer Code Issued by Bureau of Census" => {
                    Some(FilerCodeIssuedByBureauOfCensus)
                }
                "Food and Drug Administration (FDA) Registration Number" => Some(CodeFDA),
                "United States Department of Agriculture - FoodData Central Food Code" => {
                    Some(UnitedStatesDepartmentOfAgricultureFoodDataCentralFoodCode)
                }
                ...
                "Federal Firearms License" => Some(FederalFirearmsLicense),
                ...
                "Federal Item Identification Guide" => {
                    Some(FederalItemIdentificationGuide)
                }
                ...
                "Forest Stewardship Councils Chain of Custody Certificate Number" => {
                    Some(ForestStewardshipCouncilsChainOfCustodyCertificateNumber)
                }
                ...
                "Global Document Type Identifier" => Some(GlobalDocumentType),
                ...
                "Gender Limits ID" => Some(GenderLimitsId),
                "Loan Acquisition Number" => Some(LoanAcquisitionNumber),
                "General Message ID" => Some(GeneralMessageId),
                ...
                "Health Care Services Review Decision Reason Code" => {
                    Some(HealthCareServicesReviewDecisionReasonCode)
                }
                "Department of Transportation Hazardous Number" => {
                ...
                "House Waybill" => Some(HouseWaybill),
                "Master Waybill" => Some(MasterWaybill),
                "Preferred Gateway Identifier" => Some(PreferredGateway),
                "Shipment Valuation" => Some(ShipmentValuation),
                "Standard Unique Health Identifier for Health Care Providers (NPI)" => {
                    Some(CodeHPI)
                }
                ...
                "Harmonized Tariff Schedule of the United States" => {
                    Some(HarmonizedTariffScheduleOfTheUnitedStates)
                }
                ...
                "ICCID - Integrated Card Circuit Identifier" => {
                    Some(IccidIntegratedCardCircuit)
                }
                "ICD-9-CM (International Classification of Diseases, 9th Revision, Clinical Modification)" => {
                    Some(CodeICD)
                }
                ...
                "Ingredient Reference" => Some(IngredientReference),
                ...
                "International Mobile Equipment Identity" => {
                    Some(InternationalMobileEquipmentIdentity)
                }
                ...
                "Drug Ingredient Reference" => Some(DrugIngredientReference),
                ...
                "Census Internal Transaction Number (ITN)" => Some(CodeITN),
                ...
                "Kosher Certification Number" => Some(KosherCertificationNumber),
                ...
                "Load Configuration Pattern Number" => {
                    Some(LoadConfigurationPatternNumber)
                }
                "Loan Number" => Some(LoanNumber),
                "Loading Group" => Some(LoadingGroup),
                "Lender Entity Number" => Some(LenderEntityNumber),
                "Locomotive Engineer License" => Some(LocomotiveEngineerLicense),
                ...
                "Port of Load Location Number" => Some(PortOfLoadLocationNumber),
                ...
                "Medical Device Class" => Some(MedicalDeviceClass),
                "Medical Device License Number" => Some(MedicalDeviceLicenseNumber),
                "Hazardous Waste Manifest Document Number" => {
                    Some(HazardousWasteManifestDocumentNumber)
                }
                "Message Address or ID" => Some(MessageAddressOrId),
                "MEID - Mobile Equipment Identifier" => Some(MeidMobileEquipment),
                ...
                "Mexico Tariff Rate Code (Fracción Arancelaria)" => Some(CodeMTC),
                ...
                "Mexican Harmonized Alphanumeric Carrier (CAAT) Code" => Some(CodeMXC),
                "Mexican Export Bonded Warehouse Number" => {
                    Some(MexicanExportBondedWarehouseNumber)
                }
                "Mexican Import Bonded Warehouse Number" => {
                    Some(MexicanImportBondedWarehouseNumber)
                }
                ...
                "Natural Product Number" => Some(NaturalProductNumber),
                "Medicaid Recipient Identification Number" => {
                ...
                "Organic Certification Number" => Some(OrganicCertificationNumber),
                "Original Return Request Reference Number" => {
                ...
                "Healthcare Other Entity ID (OEID)" => Some(CodeOEI),
                ...
                "Overflow Indicator Code" => Some(OverflowIndicatorCode),
                ...
                "Prior Authorization ID" => Some(PriorAuthorizationId),
                "Nonprovisional Patent Application Number" => {
                ...
                "Pharmacy Chain ID" => Some(PharmacyChainId),
                "State of Jurisdiction" => Some(StateOfJurisdiction),
                ...
                "Census Post Departure Filing Number" => {
                    Some(CensusPostDepartureFilingNumber)
                }
                ...
                "Product Exclusion ID" => Some(ProductExclusionId),
                ...
                "Department of Defense Provisioning Line Item Sequence Number" => {
                    Some(DepartmentOfDefenseProvisioningLineItemSequenceNumber)
                }
                "Proposed Contract Number" => Some(ProposedContractNumber),
                "Part Number" => Some(PartNumber),
                "Packaging Marking Indicator" => Some(PackagingMarkingIndicator),
                "Premarket Application Number" => Some(PremarketApplicationNumber),
                "Permit Number" => Some(PermitNumber),
                "Pharmacy Network ID" => Some(PharmacyNetworkId),
                "Pharmacy Network" => Some(PharmacyNetwork),
                "Patent Number" => Some(PatentNumber),
                "Purchase Order Number" => Some(PurchaseOrderNumber),
                "Port of Destination Location Number" => {
                    Some(PortOfDestinationLocationNumber)
                }
                ...
                "Portal Submission Code" => Some(PortalSubmissionCode),
                "Previous Shipment Identification Number - Continuous Move" => {
                ...
                "Provisioning Control Code" => Some(ProvisioningControlCode),
                ...
                "Reimbursable Code" => Some(ReimbursableCode),
                "Related Case" => Some(RelatedCase),
                "DHS (Department of Homeland Security) Re-entry Permit" => Some(CodeREP),
                ...
                "Railroad Board (RRB) Number" => Some(CodeRRB),
                ...
                "Department of Transportation Retread Tire Identification Number" => {
                    Some(DepartmentOfTransportationRetreadTireIdentificationNumber)
                }
                "DHS (Department of Homeland Security) Travel Document" => Some(CodeRTP),
                ...
                "Standard Inter-Service Agency Serial Control Number" => {
                    Some(StandardInterServiceAgencySerialControlNumber)
                }
                "Sub Account" => Some(SubAccount),
                "Sales Region Number" => Some(SalesRegionNumber),
                "Sub Allocation" => Some(SubAllocation),
                "Shared Benefit Class Number" => Some(SharedBenefitClassNumber),
                ...
                "Security Cooperation Customer Code" => {
                    Some(SecurityCooperationCustomerCode)
                }
                "Security Cooperation Implementing Agency" => {
                    Some(SecurityCooperationImplementingAgency)
                }
                "Sub Class" => Some(SubClass),
                ...
                "Step Medication Group ID" => Some(StepMedicationGroupId),
                "Step Medication Triggers ID" => Some(StepMedicationTriggersId),
                "Step Medication Links ID" => Some(StepMedicationLinksId),
                ...
                "U.S. Customs & Border Protection (CBP) Second Notify Party" => {
                    Some(CodeSNP)
                }
                ...
                "State of Claim Jurisdiction" => Some(StateOfClaimJurisdiction),
                "Scan Line" => Some(ScanLine),
                "Specialty Products ID" => Some(SpecialtyProductsId),
                "Standard Point Location Code (SPLC)" => Some(CodeSPL),
                "Theater Screen Number" => Some(TheaterScreenNumber),
                "Parent Contract" => Some(ParentContract),
                ...
                "Superceded Contract" => Some(SupercededContract),
                "Related Contract" => Some(RelatedContract),
                ...
                "Approved Third-Party Certifier" => Some(ApprovedThirdPartyCertifier),
                "Transponder Number" => Some(TransponderNumber),
                "Temperature Recorder Serial Number" => {
                    Some(TemperatureRecorderSerialNumber)
                }
                "Tracer Action Request Number" => Some(TracerActionRequestNumber),
                "Government Transportation Request" => {
                    Some(GovernmentTransportationRequest)
                }
                "Transfer Carrier" => Some(TransferCarrier),
                ...
                "VICS Bill of Lading Number (17 Digits)" => Some(CodeUCB),
                "VICS Master Bill of Lading Number (17 Digits)" => Some(CodeUCM),
                ...
                "United Nations Location Code (UNLOCODE) Number" => Some(CodeULC),
                ...
                "Uniform Resource Identifier" => Some(UniformResource),
                ...
                "Universal Unique Identifier (UUID)" => Some(CodeUUI),
                ...
                "Waste Disposal Number" => Some(WasteDisposalNumber),
                "Interim Funding Organization Loan Number" => {
                ...
                "Planning Schedule Type Code" => Some(PlanningScheduleTypeCode),
                "Status Report Code" => Some(StatusReportCode),
                "Inventory Transaction Type Code" => Some(InventoryTransactionTypeCode),
                "Report Type Code" => Some(ReportTypeCode),
                ...
                "Rent Payer Identification" => Some(RentPayerIdentification),
                ...
                "Minimum Royalty Payer Identification" => {
                    Some(MinimumRoyaltyPayerIdentification)
                }
                ...
                "Residue Indicator Code" => Some(ResidueIndicatorCode),
