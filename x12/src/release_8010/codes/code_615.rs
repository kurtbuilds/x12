...
impl TimePeriodQualifier {
    ...
    pub fn from_code(code: &[u8]) -> Option<TimePeriodQualifier> {
        ...
        match code {
            ...
            b"38" => Some(Used),
            b"39" => Some(MemberAgeYears),
            b"40" => Some(MemberAgeMonths),
            b"41" => Some(Session),
            b"42" => Some(Period),
            b"43" => Some(Code43),
            b"44" => Some(Code44),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Used => "Used",
            MemberAgeYears => "Member Age - Years",
            MemberAgeMonths => "Member Age - Months",
            Session => "Session",
            Period => "Period",
            Code43 => "Dose(s)",
            Code44 => "Month(s)",
    ...
    fn from_description(description: &str) -> Option<TimePeriodQualifier> {
        {
            ...
            match description {
                ...
                "Used" => Some(Used),
                "Member Age - Years" => Some(MemberAgeYears),
                "Member Age - Months" => Some(MemberAgeMonths),
