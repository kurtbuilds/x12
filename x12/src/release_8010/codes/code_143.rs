...
pub enum TransactionSetIdentifierCode {
    ...
    CustomsExportShipment,
    ///603 - Transportation Equipment Registration
    TransportationEquipmentRegistration,
    ...
    TradingPartnerPerformanceMeasurements,
...
impl TransactionSetIdentifierCode {
    ...
    pub fn from_code(code: &[u8]) -> Option<TransactionSetIdentifierCode> {
        ...
        match code {
            ...
            b"352" => Some(CustomsCarrierGeneralOrderStatus),
            b"353" => Some(CustomsEventsAdvisoryDetails),
            b"354" => Some(CustomsAutomatedManifestArchiveStatus),
            b"355" => Some(CustomsAcceptanceRejection),
            b"356" => Some(CustomsPermitToTransferRequest),
            b"357" => Some(CustomsInBond),
            b"358" => Some(CustomsConsist),
            b"359" => Some(CustomsCustomerProfileManagement),
            b"361" => Some(Code361),
            ...
            b"432" => Some(RailCarHireRateNegotiation),
            ...
            b"601" => Some(CustomsExportShipment),
            b"603" => Some(TransportationEquipmentRegistration),
            ...
            b"892" => Some(TradingPartnerPerformanceMeasurements),
            ...
            b"897" => Some(DataSynchronization),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            CustomsCarrierGeneralOrderStatus => "Customs Carrier General Order Status",
            CustomsEventsAdvisoryDetails => "Customs Events Advisory Details",
            CustomsAutomatedManifestArchiveStatus => {
                "Customs Automated Manifest Archive Status"
            }
            CustomsAcceptanceRejection => "Customs Acceptance/Rejection",
            CustomsPermitToTransferRequest => "Customs Permit to Transfer Request",
            CustomsInBond => "Customs In-Bond Information",
            CustomsConsist => "Customs Consist Information",
            CustomsCustomerProfileManagement => "Customs Customer Profile Management",
            ...
            RailCarHireRateNegotiation => "Rail Car Hire Rate Negotiation",
            ...
            CustomsExportShipment => "Customs Export Shipment Information",
            TransportationEquipmentRegistration => {
            ...
            Code890 => "Contract & Rebate Management Transaction",
    ...
    fn from_description(description: &str) -> Option<TransactionSetIdentifierCode> {
        {
            ...
            match description {
                ...
                "Customs Carrier General Order Status" => {
                    Some(CustomsCarrierGeneralOrderStatus)
                }
                "Customs Events Advisory Details" => Some(CustomsEventsAdvisoryDetails),
                "Customs Automated Manifest Archive Status" => {
                    Some(CustomsAutomatedManifestArchiveStatus)
                }
                "Customs Acceptance/Rejection" => Some(CustomsAcceptanceRejection),
                "Customs Permit to Transfer Request" => {
                    Some(CustomsPermitToTransferRequest)
                }
                "Customs In-Bond Information" => Some(CustomsInBond),
                "Customs Consist Information" => Some(CustomsConsist),
                "Customs Customer Profile Management" => {
                    Some(CustomsCustomerProfileManagement)
                }
                ...
                "Rail Car Hire Rate Negotiation" => Some(RailCarHireRateNegotiation),
                ...
                "Customs Export Shipment Information" => Some(CustomsExportShipment),
                "Transportation Equipment Registration" => {
                    Some(TransportationEquipmentRegistration)
                }
                ...
                "Contract & Rebate Management Transaction" => Some(Code890),
                "Deduction Research Report" => Some(DeductionResearchReport),
                "Trading Partner Performance Measurements" => {
                    Some(TradingPartnerPerformanceMeasurements)
                }
                ...
                "Data Synchronization" => Some(DataSynchronization),
                "Loss or Damage Claim - General Commodities" => {
