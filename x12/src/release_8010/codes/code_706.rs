...
impl EntityRelationshipCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                FormerSpouse => "AV",
                Ward => "AW",
                DeliveryServiceProvider => "BA",
                MaintenanceServiceProvider => "BB",
                CustodialParent => "CP",
                EquipmentProvider => "EP",
                Local => "LO",
                ObligatedParent => "OP",
                Principal => "PI",
                Regional => "RE",
    ...
    pub fn from_code(code: &[u8]) -> Option<EntityRelationshipCode> {
        ...
        match code {
            ...
            b"AW" => Some(Ward),
            b"BA" => Some(DeliveryServiceProvider),
            b"BB" => Some(MaintenanceServiceProvider),
            b"CP" => Some(CustodialParent),
            b"EP" => Some(EquipmentProvider),
            b"LO" => Some(Local),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Owner => "Owner",
            Code39 => "Related for U.S. Customs and Border Protection (CBP) Purposes",
            RelatedForUSBureauOfTheCensusPurposes => {
            ...
            Ward => "Ward",
            DeliveryServiceProvider => "Delivery Service Provider",
    ...
    fn from_description(description: &str) -> Option<EntityRelationshipCode> {
        {
            ...
            match description {
                ...
                "Owner" => Some(Owner),
                "Related for U.S. Customs and Border Protection (CBP) Purposes" => {
                    Some(Code39)
                }
                "Related for U.S. Bureau of the Census Purposes" => {
                ...
                "Ward" => Some(Ward),
                "Delivery Service Provider" => Some(DeliveryServiceProvider),
                "Maintenance Service Provider" => Some(MaintenanceServiceProvider),
                "Custodial Parent" => Some(CustodialParent),
                "Equipment Provider" => Some(EquipmentProvider),
                "Local" => Some(Local),
