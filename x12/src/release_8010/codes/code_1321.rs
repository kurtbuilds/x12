...
See docs at <https://www.stedi.com/edi/x12/element/1321>*/
...
Response Plan*/
    ...
    ///111 - Contains Bovine
    ContainsBovine,
    ///112 - Contains Di(2-ethylhexyl)phthalate (DEHP)
    Code112,
    ///113 - Contains Halogenated Organics
    ContainsHalogenatedOrganics,
    ///114 - Implantable Trade Item
    ImplantableTradeItem,
    ///115 - Contains Latex
    ContainsLatex,
    ///116 - Contains Mercury
    ContainsMercury,
    ///117 - Contains Polybutylene Terephthalate (PBT)
    Code117,
    ///118 - Contains Porcine
    ContainsPorcine,
    ///119 - Contains Polyvinyl Chloride
    ContainsPolyvinylChloride,
    ///120 - Single Patient Use Only
    SinglePatientUseOnly,
    ///121 - Single Use Only
    SingleUseOnly,
    ///122 - Product is Pre-Priced on Package
    ProductIsPrePricedOnPackage,
    ///123 - Product Contains Latex
    ProductContainsLatex,
    ///124 - Packaging Contains Latex
    PackagingContainsLatex,
    ...
    AddressSkipResolved,
    ///ARA - American Recovery and Reinvestment Act (ARRA) Compliant
    CodeARA,
    ///AS - Address Skip Exhaust
    AddressSkipExhaust,
    ///ASO - Available for Special Order
    ...
    ///BAA - Buy American Act (BAA) Compliant
    CodeBAA,
    ...
    ///BD - Business Pending
    BusinessPending,
    ///BDS - Barcode Symbology Derivable
    BarcodeSymbologyDerivable,
    ...
    ///CA - Cane Required
    CaneRequired,
    ///CAI - Component Assembly Inspection Required
    ComponentAssemblyInspectionRequired,
    ///CB - Complete Bedrest
    CompleteBedrest,
    ///CC - Collection Card was Left
    CollectionCardWasLeft,
    ///CCP - Composition Claim 100% Pure
    CodeCCP,
    ...
    ///CLD - Contractor Liable for Discrepancy
    ContractorLiableForDiscrepancy,
    ///CM - Comatose
    Comatose,
    ...
    ///DAA - Unrounded Number (Absolute)
    CodeDAA,
    ///DAR - Rounded Number
    RoundedNumber,
    ///DB - Deferment or Forbearance Begin
    DefermentOrForbearanceBegin,
    ///DBR - Distribution is Restricted
    DistributionIsRestricted,
    ///DBU - Branded Distribution Product
    BrandedDistributionProduct,
    ///DC - Declined
    Declined,
    ///DCD - Direct to Consumer Delivery
    DirectToConsumerDelivery,
    ///DD - Borrower Furnished Demographic Data
    BorrowerFurnishedDemographicData,
    ///DDS - Defined Distribution
    DefinedDistribution,
    ...
    ///EQ - Has No Par Value
    HasNoParValue,
    ///EQR - Equipment is Remanufactured or has been Assigned a New Equipment Initial
    EquipmentIsRemanufacturedOrHasBeenAssignedANewEquipmentInitial,
    ...
    ///FC1 - Include in Next Shipment
    IncludeInNextShipment,
    ///FC2 - Promotional Buy
    PromotionalBuy,
    ///FC3 - Same Dye Lot is Required
    SameDyeLotIsRequired,
    ...
    ///FFM - Free from Monosodium Glutamate (MSG)
    CodeFFM,
    ///FFP - Free From Preservatives
    FreeFromPreservatives,
    ...
    ///ITF - Product Package Marked with Interleaved 2 of 5 (ITF-14)
    CodeITF,
    ...
    ///LPC - Legislative Price Control in Effect
    LegislativePriceControlInEffect,
...
(OSHA) Star or Merit Ranking*/
    ...
    ///MAE - Microbiological Aerobic Spores
    MicrobiologicalAerobicSpores,
    ///MAN - Microbiological Anerobic Spores
    MicrobiologicalAnerobicSpores,
    ///MB - Equipment has Modified Configuration
    EquipmentHasModifiedConfiguration,
    ///MBB - Marked with a Best Before Date
    MarkedWithABestBeforeDate,
    ///MC - Other Mental Condition
    OtherMentalCondition,
    ///MCD - Made in Canada from Domestic and Imported Ingredients
    MadeInCanadaFromDomesticAndImportedIngredients,
    ///MCI - Made in Canada from Imported Ingredients
    MadeInCanadaFromImportedIngredients,
    ///MD - Marketing Time is 4 to 6 Months
    MarketingTimeIs4To6Months,
    ///MDR - Mild Retardation
    MildRetardation,
    ///ME - Trend Reversed
    TrendReversed,
    ///MED - Marked with an Expiry Date
    MarkedWithAnExpiryDate,
    ///MET - Marked with a Lot Number
    MarkedWithALotNumber,
    ...
    ///MPD - Marked with a Packing Date
    MarkedWithAPackingDate,
    ///MPF - Made in a Peanut-Free Facility
    MadeInAPeanutFreeFacility,
    ///MQ - Eligible Trust
    EligibleTrust,
    ///MR - Resale Property
    ResaleProperty,
    ///MRD - Marked with Production Date
    MarkedWithProductionDate,
    ...
    NoUserAvailable,
    ///NAC - No Artificial Colorings, Dyes, Pigments
    CodeNAC,
    ///NAF - No Artificial Flavorings
    NoArtificialFlavorings,
    ...
    ///NF - New Construction
    NewConstruction,
    ///NFT - Trade Item Exempt from Nutritional Facts Table
    TradeItemExemptFromNutritionalFactsTable,
    ...
    RetailOrigination,
    ///NML - Nutrition Information Marked on Label
    NutritionInformationMarkedOnLabel,
    ...
    ///NR - No Restrictions
    NoRestrictions,
    ///NRD - Nutrient Relevant Data Provided
    ...
    ///OB - Fixed Site
    FixedSite,
    ///OBD - Organic Biodynamic
    OrganicBiodynamic,
    ///OC - Mobile Facility
    MobileFacility,
    ///OD - Transfer Authorized
    TransferAuthorized,
    ///ODS - Open Distribution
    OpenDistribution,
    ...
    ///OPI - Product Is Organic
    ProductIsOrganic,
    ///OQ - Photographs Taken
    PhotographsTaken,
    ///OR - Other Restrictions
    OtherRestrictions,
    ///ORG - Organic Product 95%
    CodeORG,
    ///ORH - Organic Product 100%
    CodeORH,
    ///ORI - Organic Product 70% to 95%
    CodeORI,
    ///ORP - Organic Product Less Than 70%
    CodeORP,
    ///OS - Out of Service
    OutOfService,
    ///OT - Oriented
    ...
    ///PA - Paralysis
    Paralysis,
    ///PAL - Patient Is Allowed To Leave Residence
    PatientIsAllowedToLeaveResidence,
    ///PAR - Paraplegia
    Paraplegia,
    ///PB - Phone Skip Begin
    PhoneSkipBegin,
    ///PC - Plan is Attached
    PlanIsAttached,
    ///PCF - Product Composition Claim is Fresh
    ProductCompositionClaimIsFresh,
    ///PCP - Product Contains Probiotic
    ProductContainsProbiotic,
    ///PD - Phone Skip Resolved
    PhoneSkipResolved,
    ///PDV - Product Divisible
    ProductDivisible,
    ...
    ///PI - Program
    Program,
    ///PIC - Packaged in Canada
    PackagedInCanada,
    ///PIR - Product is Re-Orderable
    ProductIsReOrderable,
    ...
    ///PNA - Product Substitution is Not Allowed
    ProductSubstitutionIsNotAllowed,
    ///PO - Personal Property Onsite
    PersonalPropertyOnsite,
    ///POC - Purchase Order Carton Consolidation (POCC) for this Carton
    CodePOC,
    ///POS - Purchase Order Carton Consolidation (POCC) for this Shipment
    CodePOS,
    ...
    ///PR - Poor
    Poor,
    ///PRC - Product of Canada
    ProductOfCanada,
    ///PRD - Prior Damage
    PriorDamage,
    ///PRE - Prepared in Canada
    PreparedInCanada,
    ///PRI - Private Label
    PrivateLabel,
    ///PRO - Processed in Canada
    ProcessedInCanada,
    ///PS - Publication is Included in Sharing
    PublicationIsIncludedInSharing,
    ///PSA - Product Substitution is Allowed
    ProductSubstitutionIsAllowed,
    ///PSE - Product Substitution is Allowed as Specified
    ProductSubstitutionIsAllowedAsSpecified,
    ///PT - Project is Complete
    ProjectIsComplete,
    ///PTH - Patient Is Homebound
    PatientIsHomebound,
    ///PU - Not Paid
    NotPaid,
    ...
    USGoodsReturned,
    ///Q4 - Candidate for U.S. Customs and Border Protection (CBP) Protest
    CodeQ4,
    ///Q5 - Domestic Product
    DomesticProduct,
    ...
    ///RPR - Retail Price on Trade Item
    ...
    ///S01 - Product is Pre-Prepared
    ProductIsPrePrepared,
    ///S2 - Under Treatment
    UnderTreatment,
    ///S02 - Product is Used As Is
    ProductIsUsedAsIs,
    ...
    ///SAA - Generic Name is Same As Active Ingredient Name
    GenericNameIsSameAsActiveIngredientName,
    ...
    ///SEL - Sell
    Sell,
    ///SER - Manufacturer Product Serial Numbers are Included
    ManufacturerProductSerialNumbersAreIncluded,
    ///SF - Sensor Fault
    SensorFault,
    ...
    ///SS - Adverse Zoning
    AdverseZoning,
    ///SSL - Seasonal Product
    SeasonalProduct,
    ///ST - New Services Requested
    NewServicesRequested,
    ///STA - Stackable
    Stackable,
    ///STB - Self-Threatening Behavior
    SelfThreateningBehavior,
    ...
    ///TBO - Threatening Behavior Toward Others
    ThreateningBehaviorTowardOthers,
    ...
    ///TIB - Trade Item is Biodegradable
    TradeItemIsBiodegradable,
    ///TIR - Trade Item is Restricted
    TradeItemIsRestricted,
    ...
    ///UPC - Product Package Marked with UPC (Universal Product Code)
    CodeUPC,
    ...
    ///US - Enclosed
    Enclosed,
    ///USP - Product Subject to United States Patent
    ProductSubjectToUnitedStatesPatent,
    ///UT - Up as Tolerated
    UpAsTolerated,
    ...
    ///UU7 - Variable Unit
    VariableUnit,
    ///UUA - Packaging Marked Returnable
    PackagingMarkedReturnable,
    ///UUB - Packaging Marked Recyclable
    PackagingMarkedRecyclable,
    ///UUC - Returnable Product
    ReturnableProduct,
    ///UUD - Regulatory Identification Pending
    RegulatoryIdentificationPending,
    ///UUE - Assembly Required
    AssemblyRequired,
    ///UUF - Battery Required
    BatteryRequired,
    ///UUG - Batteries Included
    BatteriesIncluded,
    ///UUH - Certified Angus Beef
    CertifiedAngusBeef,
    ///UUI - Serving Has Been Pre Prepared
    ServingHasBeenPrePrepared,
    ///UUJ - Serving As Is
    ServingAsIs,
    ///UUK - Product Has Been Recalled
    ProductHasBeenRecalled,
    ///UUL - Injectable Trade Item
    InjectableTradeItem,
    ///UUM - Product Has an Auto Reader or Auto Tracker
    ProductHasAnAutoReaderOrAutoTracker,
    ///UUN - Allergen Relevant Data Provided
    AllergenRelevantDataProvided,
    ///UUO - Biomedical Hazard Antineoplastic
    BiomedicalHazardAntineoplastic,
    ///UUP - Biomedical Hazard Biologic
    BiomedicalHazardBiologic,
    ///UUQ - Biomedical Hazard Cytotoxic
    BiomedicalHazardCytotoxic,
    ///UUR - Biomedical Hazard Radioactive
    BiomedicalHazardRadioactive,
    ///UUS - Product Contains Liquid
    ProductContainsLiquid,
    ///UUT - Aerosol Container
    AerosolContainer,
    ///UUU - Product is Sterile
    ProductIsSterile,
    ///UUV - Generic Name is same as Active Ingredient Name
    CodeUUV,
...
impl ConditionIndicatorCode {
    pub fn code(&self) -> &str {
        {
            use ConditionIndicatorCode::*;
            match self {
                Requested => "00",
                InProgress => "000",
                Code0A => "0A",
                ...
                ContainsBovine => "111",
                Code112 => "112",
                ContainsHalogenatedOrganics => "113",
                ImplantableTradeItem => "114",
                ContainsLatex => "115",
                ContainsMercury => "116",
                Code117 => "117",
                ContainsPorcine => "118",
                ContainsPolyvinylChloride => "119",
                SinglePatientUseOnly => "120",
                SingleUseOnly => "121",
                ProductIsPrePricedOnPackage => "122",
                ProductContainsLatex => "123",
                PackagingContainsLatex => "124",
                ...
                CaneRequired => "CA",
                ComponentAssemblyInspectionRequired => "CAI",
                CompleteBedrest => "CB",
                ...
                ContractorLiableForDiscrepancy => "CLD",
                Comatose => "CM",
                ...
                DistributionIsRestricted => "DBR",
                BrandedDistributionProduct => "DBU",
                Declined => "DC",
                DirectToConsumerDelivery => "DCD",
                BorrowerFurnishedDemographicData => "DD",
                DefinedDistribution => "DDS",
                ...
                HasNoParValue => "EQ",
                EquipmentIsRemanufacturedOrHasBeenAssignedANewEquipmentInitial => "EQR",
                ...
                IncludeInNextShipment => "FC1",
                PromotionalBuy => "FC2",
                SameDyeLotIsRequired => "FC3",
                ...
                LegislativePriceControlInEffect => "LPC",
                ...
                MicrobiologicalAerobicSpores => "MAE",
                MicrobiologicalAnerobicSpores => "MAN",
                EquipmentHasModifiedConfiguration => "MB",
                MarkedWithABestBeforeDate => "MBB",
                OtherMentalCondition => "MC",
                MadeInCanadaFromDomesticAndImportedIngredients => "MCD",
                MadeInCanadaFromImportedIngredients => "MCI",
                MarketingTimeIs4To6Months => "MD",
                MildRetardation => "MDR",
                TrendReversed => "ME",
                MarkedWithAnExpiryDate => "MED",
                MarkedWithALotNumber => "MET",
                ...
                MarkedWithAPackingDate => "MPD",
                MadeInAPeanutFreeFacility => "MPF",
                EligibleTrust => "MQ",
                ResaleProperty => "MR",
                MarkedWithProductionDate => "MRD",
                ...
                Notarized => "NE",
                NewConstruction => "NF",
                TradeItemExemptFromNutritionalFactsTable => "NFT",
                ...
                NutritionInformationMarkedOnLabel => "NML",
                CodeNN => "NN",
                ...
                NoRestrictions => "NR",
                NutrientRelevantDataProvided => "NRD",
                CodeNS => "NS",
                LodgingProvided => "NT",
                NotUsed => "NU",
                ContractLabor => "NV",
                ...
                FixedSite => "OB",
                OrganicBiodynamic => "OBD",
                MobileFacility => "OC",
                TransferAuthorized => "OD",
                OpenDistribution => "ODS",
                ...
                Paralysis => "PA",
                PatientIsAllowedToLeaveResidence => "PAL",
                Paraplegia => "PAR",
                PhoneSkipBegin => "PB",
                PlanIsAttached => "PC",
                ProductCompositionClaimIsFresh => "PCF",
                ProductContainsProbiotic => "PCP",
                PhoneSkipResolved => "PD",
                ProductDivisible => "PDV",
                PhoneSkipExhaust => "PE",
                PaidOutsideOfClosing => "PF",
                PreviouslyFailedBoardCertification => "PFB",
                ProductHasFauxFur => "PFF",
                ProjectIsSubjectToGroundRent => "PG",
                Prepayable => "PH",
                Program => "PI",
                PackagedInCanada => "PIC",
                ProductIsReOrderable => "PIR",
                ...
                ProductSubstitutionIsNotAllowed => "PNA",
                ...
                ProductOfCanada => "PRC",
                PriorDamage => "PRD",
                PreparedInCanada => "PRE",
                PrivateLabel => "PRI",
                ProcessedInCanada => "PRO",
                PublicationIsIncludedInSharing => "PS",
                ProductSubstitutionIsAllowed => "PSA",
                ProductSubstitutionIsAllowedAsSpecified => "PSE",
                ProjectIsComplete => "PT",
                PatientIsHomebound => "PTH",
                NotPaid => "PU",
                ...
                ProductIsPrePrepared => "S01",
                UnderTreatment => "S2",
                ProductIsUsedAsIs => "S02",
                FirstTimeVacant => "S3",
                AdverseEasement => "S4",
                ...
                GenericNameIsSameAsActiveIngredientName => "SAA",
                ...
                ThreateningBehaviorTowardOthers => "TBO",
                ...
                TradeItemIsBiodegradable => "TIB",
                TradeItemIsRestricted => "TIR",
                ...
                Enclosed => "US",
                ProductSubjectToUnitedStatesPatent => "USP",
                UpAsTolerated => "UT",
                CodeUU => "UU",
                SingleUnit => "UU1",
                BaseUnit => "UU2",
                ...
                ShippingUnit => "UU6",
                VariableUnit => "UU7",
                PackagingMarkedReturnable => "UUA",
                PackagingMarkedRecyclable => "UUB",
                ReturnableProduct => "UUC",
                RegulatoryIdentificationPending => "UUD",
                AssemblyRequired => "UUE",
                BatteryRequired => "UUF",
                BatteriesIncluded => "UUG",
                CertifiedAngusBeef => "UUH",
                ServingHasBeenPrePrepared => "UUI",
                ServingAsIs => "UUJ",
                ProductHasBeenRecalled => "UUK",
                InjectableTradeItem => "UUL",
                ProductHasAnAutoReaderOrAutoTracker => "UUM",
                AllergenRelevantDataProvided => "UUN",
                BiomedicalHazardAntineoplastic => "UUO",
                BiomedicalHazardBiologic => "UUP",
                BiomedicalHazardCytotoxic => "UUQ",
                BiomedicalHazardRadioactive => "UUR",
                ProductContainsLiquid => "UUS",
                AerosolContainer => "UUT",
                ProductIsSterile => "UUU",
                CodeUUV => "UUV",
    ...
    pub fn from_code(code: &[u8]) -> Option<ConditionIndicatorCode> {
        use ConditionIndicatorCode::*;
        match code {
            b"00" => Some(Requested),
            ...
            b"001" => Some(AllItemsPriceTagged),
            ...
            b"111" => Some(ContainsBovine),
            b"112" => Some(Code112),
            b"113" => Some(ContainsHalogenatedOrganics),
            b"114" => Some(ImplantableTradeItem),
            b"115" => Some(ContainsLatex),
            b"116" => Some(ContainsMercury),
            b"117" => Some(Code117),
            b"118" => Some(ContainsPorcine),
            b"119" => Some(ContainsPolyvinylChloride),
            b"120" => Some(SinglePatientUseOnly),
            b"121" => Some(SingleUseOnly),
            b"122" => Some(ProductIsPrePricedOnPackage),
            b"123" => Some(ProductContainsLatex),
            b"124" => Some(PackagingContainsLatex),
            ...
            b"ASO" => Some(AvailableForSpecialOrder),
            ...
            b"BDS" => Some(BarcodeSymbologyDerivable),
            ...
            b"CAI" => Some(ComponentAssemblyInspectionRequired),
            ...
            b"DAA" => Some(CodeDAA),
            b"DAR" => Some(RoundedNumber),
            b"DB" => Some(DefermentOrForbearanceBegin),
            b"DBR" => Some(DistributionIsRestricted),
            b"DBU" => Some(BrandedDistributionProduct),
            b"DC" => Some(Declined),
            b"DCD" => Some(DirectToConsumerDelivery),
            b"DD" => Some(BorrowerFurnishedDemographicData),
            b"DDS" => Some(DefinedDistribution),
            ...
            b"EQR" => {
                Some(EquipmentIsRemanufacturedOrHasBeenAssignedANewEquipmentInitial)
            }
            ...
            b"FC1" => Some(IncludeInNextShipment),
            b"FC2" => Some(PromotionalBuy),
            b"FC3" => Some(SameDyeLotIsRequired),
            ...
            b"FFM" => Some(CodeFFM),
            b"FFP" => Some(FreeFromPreservatives),
            ...
            b"FR" => Some(Fair),
            b"FRT" => Some(FederallyReportable),
            ...
            b"LPC" => Some(LegislativePriceControlInEffect),
            ...
            b"MAE" => Some(MicrobiologicalAerobicSpores),
            b"MAN" => Some(MicrobiologicalAnerobicSpores),
            b"MB" => Some(EquipmentHasModifiedConfiguration),
            b"MBB" => Some(MarkedWithABestBeforeDate),
            b"MC" => Some(OtherMentalCondition),
            b"MCD" => Some(MadeInCanadaFromDomesticAndImportedIngredients),
            b"MCI" => Some(MadeInCanadaFromImportedIngredients),
            b"MD" => Some(MarketingTimeIs4To6Months),
            b"MDR" => Some(MildRetardation),
            b"ME" => Some(TrendReversed),
            b"MED" => Some(MarkedWithAnExpiryDate),
            b"MET" => Some(MarkedWithALotNumber),
            ...
            b"MPD" => Some(MarkedWithAPackingDate),
            b"MPF" => Some(MadeInAPeanutFreeFacility),
            b"MQ" => Some(EligibleTrust),
            b"MR" => Some(ResaleProperty),
            b"MRD" => Some(MarkedWithProductionDate),
            ...
            b"MWM" => Some(MadeWithNewMaterial),
            ...
            b"NAC" => Some(CodeNAC),
            b"NAF" => Some(NoArtificialFlavorings),
            ...
            b"NFT" => Some(TradeItemExemptFromNutritionalFactsTable),
            ...
            b"NML" => Some(NutritionInformationMarkedOnLabel),
            b"NN" => Some(CodeNN),
            ...
            b"NRD" => Some(NutrientRelevantDataProvided),
            b"NS" => Some(CodeNS),
            ...
            b"OB" => Some(FixedSite),
            b"OBD" => Some(OrganicBiodynamic),
            b"OC" => Some(MobileFacility),
            b"OD" => Some(TransferAuthorized),
            b"ODS" => Some(OpenDistribution),
            ...
            b"PNA" => Some(ProductSubstitutionIsNotAllowed),
            ...
            b"PR" => Some(Poor),
            b"PRC" => Some(ProductOfCanada),
            b"PRD" => Some(PriorDamage),
            b"PRE" => Some(PreparedInCanada),
            b"PRI" => Some(PrivateLabel),
            b"PRO" => Some(ProcessedInCanada),
            b"PS" => Some(PublicationIsIncludedInSharing),
            b"PSA" => Some(ProductSubstitutionIsAllowed),
            b"PSE" => Some(ProductSubstitutionIsAllowedAsSpecified),
            b"PT" => Some(ProjectIsComplete),
            b"PTH" => Some(PatientIsHomebound),
            b"PU" => Some(NotPaid),
            b"PV" => Some(PropertyVacant05Percent),
            b"PW" => Some(PartialWeightBearing),
            b"PWP" => Some(PurchaseWithPurchase),
            ...
            b"ROH" => Some(RoHsIndicator),
            b"RP" => Some(IndividualInjuredInPerformanceOfDuty),
            b"RPR" => Some(RetailPriceOnTradeItem),
            ...
            b"RTI" => Some(ReturnableTradeItem),
            ...
            b"S01" => Some(ProductIsPrePrepared),
            b"S2" => Some(UnderTreatment),
            b"S02" => Some(ProductIsUsedAsIs),
            ...
            b"SAA" => Some(GenericNameIsSameAsActiveIngredientName),
            ...
            b"SSL" => Some(SeasonalProduct),
            b"ST" => Some(NewServicesRequested),
            b"STA" => Some(Stackable),
            b"STB" => Some(SelfThreateningBehavior),
            ...
            b"TBO" => Some(ThreateningBehaviorTowardOthers),
            ...
            b"TIB" => Some(TradeItemIsBiodegradable),
            b"TIR" => Some(TradeItemIsRestricted),
            ...
            b"US" => Some(Enclosed),
            b"USP" => Some(ProductSubjectToUnitedStatesPatent),
            b"UT" => Some(UpAsTolerated),
            b"UU" => Some(CodeUU),
            b"UU1" => Some(SingleUnit),
            b"UU2" => Some(BaseUnit),
            b"UU3" => Some(ConsumerUnit),
            b"UU4" => Some(InvoiceUnit),
            b"UU5" => Some(OrderableUnit),
            b"UU6" => Some(ShippingUnit),
            b"UU7" => Some(VariableUnit),
            b"UUA" => Some(PackagingMarkedReturnable),
            b"UUB" => Some(PackagingMarkedRecyclable),
            b"UUC" => Some(ReturnableProduct),
            b"UUD" => Some(RegulatoryIdentificationPending),
            b"UUE" => Some(AssemblyRequired),
            b"UUF" => Some(BatteryRequired),
            b"UUG" => Some(BatteriesIncluded),
            b"UUH" => Some(CertifiedAngusBeef),
            b"UUI" => Some(ServingHasBeenPrePrepared),
            b"UUJ" => Some(ServingAsIs),
            b"UUK" => Some(ProductHasBeenRecalled),
            b"UUL" => Some(InjectableTradeItem),
            b"UUM" => Some(ProductHasAnAutoReaderOrAutoTracker),
            b"UUN" => Some(AllergenRelevantDataProvided),
            b"UUO" => Some(BiomedicalHazardAntineoplastic),
            b"UUP" => Some(BiomedicalHazardBiologic),
            b"UUQ" => Some(BiomedicalHazardCytotoxic),
            b"UUR" => Some(BiomedicalHazardRadioactive),
            b"UUS" => Some(ProductContainsLiquid),
            b"UUT" => Some(AerosolContainer),
            b"UUU" => Some(ProductIsSterile),
            b"UUV" => Some(CodeUUV),
            ...
            b"VOD" => Some(VolumeDecrease),
            b"VOI" => Some(VolumeIncrease),
            ...
            b"WWA" => Some(AbsoluteData),
            b"WWB" => Some(RoundedData),
            b"WWO" => Some(ProductContainsWood),
            b"WX" => Some(Busy),
            b"WY" => Some(Excessive),
            b"WZ" => Some(FairlyNew),
            b"X0" => Some(CodeX0),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            AllItemsPriceTagged => "All Items Price Tagged",
            PatientIsReceivingAntiFungalTherapy => {
            ...
            ContainsBovine => "Contains Bovine",
            Code112 => "Contains Di(2-ethylhexyl)phthalate (DEHP)",
            ContainsHalogenatedOrganics => "Contains Halogenated Organics",
            ImplantableTradeItem => "Implantable Trade Item",
            ContainsLatex => "Contains Latex",
            ContainsMercury => "Contains Mercury",
            Code117 => "Contains Polybutylene Terephthalate (PBT)",
            ContainsPorcine => "Contains Porcine",
            ContainsPolyvinylChloride => "Contains Polyvinyl Chloride",
            SinglePatientUseOnly => "Single Patient Use Only",
            SingleUseOnly => "Single Use Only",
            ProductIsPrePricedOnPackage => "Product is Pre-Priced on Package",
            ProductContainsLatex => "Product Contains Latex",
            PackagingContainsLatex => "Packaging Contains Latex",
            ...
            CodeARA => "American Recovery and Reinvestment Act (ARRA) Compliant",
            AddressSkipExhaust => "Address Skip Exhaust",
            AvailableForSpecialOrder => "Available for Special Order",
            AcceptStatementOfLimitingConditionsWithoutChanges => {
            ...
            CodeBAA => "Buy American Act (BAA) Compliant",
            BuildingOrMobileHomeIsInACoastalBarrierResourcesArea => {
            ...
            BarcodeSymbologyDerivable => "Barcode Symbology Derivable",
            ...
            ContractorLiableForDiscrepancy => "Contractor Liable for Discrepancy",
            Comatose => "Comatose",
            CommonElementsAreLeasedToOrByTheHomeOwnersAssociation => {
            ...
            CodeDAA => "Unrounded Number (Absolute)",
            RoundedNumber => "Rounded Number",
            DefermentOrForbearanceBegin => "Deferment or Forbearance Begin",
            DistributionIsRestricted => "Distribution is Restricted",
            BrandedDistributionProduct => "Branded Distribution Product",
            Declined => "Declined",
            DirectToConsumerDelivery => "Direct to Consumer Delivery",
            BorrowerFurnishedDemographicData => "Borrower Furnished Demographic Data",
            DefinedDistribution => "Defined Distribution",
            ...
            EquipmentIsRemanufacturedOrHasBeenAssignedANewEquipmentInitial => {
                "Equipment is Remanufactured or has been Assigned a New Equipment Initial"
            }
            EngineStartUpPerformedWithNoProblemsReported => {
            ...
            IncludeInNextShipment => "Include in Next Shipment",
            PromotionalBuy => "Promotional Buy",
            SameDyeLotIsRequired => "Same Dye Lot is Required",
            NoticeOfConstructionOrAlterationHasBeenFiled => {
            ...
            CodeFFM => "Free from Monosodium Glutamate (MSG)",
            FreeFromPreservatives => "Free From Preservatives",
            ...
            Fair => "Fair",
            FederallyReportable => "Federally Reportable",
            ...
            CodeITF => "Product Package Marked with Interleaved 2 of 5 (ITF-14)",
            ...
            LegislativePriceControlInEffect => "Legislative Price Control in Effect",
            ...
            MicrobiologicalAerobicSpores => "Microbiological Aerobic Spores",
            MicrobiologicalAnerobicSpores => "Microbiological Anerobic Spores",
            EquipmentHasModifiedConfiguration => "Equipment has Modified Configuration",
            MarkedWithABestBeforeDate => "Marked with a Best Before Date",
            ...
            MildRetardation => "Mild Retardation",
            TrendReversed => "Trend Reversed",
            MarkedWithAnExpiryDate => "Marked with an Expiry Date",
            MarkedWithALotNumber => "Marked with a Lot Number",
            ...
            MarkedWithAPackingDate => "Marked with a Packing Date",
            MadeInAPeanutFreeFacility => "Made in a Peanut-Free Facility",
            EligibleTrust => "Eligible Trust",
            ResaleProperty => "Resale Property",
            MarkedWithProductionDate => "Marked with Production Date",
            ...
            MadeWithNewMaterial => "Made with New Material",
            ThisBrokerMarketAnalysisIsBeingCompletedForHomesaleOrBuyout => {
            ...
            CodeNAC => "No Artificial Colorings, Dyes, Pigments",
            NoArtificialFlavorings => "No Artificial Flavorings",
            NeighborhoodPredominatelySingleFamilyDwellings => {
            ...
            TradeItemExemptFromNutritionalFactsTable => {
                "Trade Item Exempt from Nutritional Facts Table"
            }
            MortgagePointsAreCustomarilyPaidBySeller => {
            ...
            NutritionInformationMarkedOnLabel => "Nutrition Information Marked on Label",
            ...
            NutrientRelevantDataProvided => "Nutrient Relevant Data Provided",
            ...
            OrganicBiodynamic => "Organic Biodynamic",
            ...
            ProductIsOrganic => "Product Is Organic",
            PhotographsTaken => "Photographs Taken",
            OtherRestrictions => "Other Restrictions",
            CodeORG => "Organic Product 95%",
            CodeORH => "Organic Product 100%",
            CodeORI => "Organic Product 70% to 95%",
            CodeORP => "Organic Product Less Than 70%",
            ...
            Paralysis => "Paralysis",
            PatientIsAllowedToLeaveResidence => "Patient Is Allowed To Leave Residence",
            Paraplegia => "Paraplegia",
            PhoneSkipBegin => "Phone Skip Begin",
            PlanIsAttached => "Plan is Attached",
            ProductCompositionClaimIsFresh => "Product Composition Claim is Fresh",
            ProductContainsProbiotic => "Product Contains Probiotic",
            PhoneSkipResolved => "Phone Skip Resolved",
            ProductDivisible => "Product Divisible",
            ...
            ProductSubstitutionIsNotAllowed => "Product Substitution is Not Allowed",
            PersonalPropertyOnsite => "Personal Property Onsite",
            CodePOC => "Purchase Order Carton Consolidation (POCC) for this Carton",
            CodePOS => "Purchase Order Carton Consolidation (POCC) for this Shipment",
            PropertyPreviouslyWinterized => "Property Previously Winterized",
            LiabilityWillBeResubordinatedToTheLoanUponClosing => {
                "Liability will be Resubordinated to the Loan upon Closing"
            }
            Poor => "Poor",
            ProductOfCanada => "Product of Canada",
            PriorDamage => "Prior Damage",
            PreparedInCanada => "Prepared in Canada",
            PrivateLabel => "Private Label",
            ProcessedInCanada => "Processed in Canada",
            PublicationIsIncludedInSharing => "Publication is Included in Sharing",
            ProductSubstitutionIsAllowed => "Product Substitution is Allowed",
            ProductSubstitutionIsAllowedAsSpecified => {
                "Product Substitution is Allowed as Specified"
            }
            ProjectIsComplete => "Project is Complete",
            PatientIsHomebound => "Patient Is Homebound",
            NotPaid => "Not Paid",
            PropertyVacant05Percent => "Property Vacant 0-5 Percent",
            PartialWeightBearing => "Partial Weight Bearing",
            PurchaseWithPurchase => "Purchase with Purchase",
            ...
            CodeQ4 => "Candidate for U.S. Customs and Border Protection (CBP) Protest",
            ...
            RefinedInCanada => "Refined in Canada",
            DebtorsSpouseMaintainsASeparateHousehold => {
            ...
            RoHsIndicator => "RoHS Indicator",
            IndividualInjuredInPerformanceOfDuty => {
                "Individual Injured in Performance of Duty"
            }
            RetailPriceOnTradeItem => "Retail Price on Trade Item",
            ...
            ReturnableTradeItem => "Returnable Trade Item",
            ...
            ProductIsPrePrepared => "Product is Pre-Prepared",
            UnderTreatment => "Under Treatment",
            ProductIsUsedAsIs => "Product is Used As Is",
            ...
            GenericNameIsSameAsActiveIngredientName => {
                "Generic Name is Same As Active Ingredient Name"
            }
            DebtorIsASmallBusinessAsDefinedIn11USCSection101 => {
            ...
            Sell => "Sell",
            ManufacturerProductSerialNumbersAreIncluded => {
                "Manufacturer Product Serial Numbers are Included"
            }
            ...
            ProductIsShakable => "Product is Shakable",
            ...
            Stackable => "Stackable",
            SelfThreateningBehavior => "Self-Threatening Behavior",
            ...
            ThreateningBehaviorTowardOthers => "Threatening Behavior Toward Others",
            ...
            TradeItemIsBiodegradable => "Trade Item is Biodegradable",
            TradeItemIsRestricted => "Trade Item is Restricted",
            ...
            CodeUPC => "Product Package Marked with UPC (Universal Product Code)",
            ...
            Enclosed => "Enclosed",
            ProductSubjectToUnitedStatesPatent => {
                "Product Subject to United States Patent"
            }
            ...
            OrderableUnit => "Orderable Unit",
            ShippingUnit => "Shipping Unit",
            VariableUnit => "Variable Unit",
            PackagingMarkedReturnable => "Packaging Marked Returnable",
            PackagingMarkedRecyclable => "Packaging Marked Recyclable",
            ReturnableProduct => "Returnable Product",
            RegulatoryIdentificationPending => "Regulatory Identification Pending",
            AssemblyRequired => "Assembly Required",
            BatteryRequired => "Battery Required",
            BatteriesIncluded => "Batteries Included",
            CertifiedAngusBeef => "Certified Angus Beef",
            ServingHasBeenPrePrepared => "Serving Has Been Pre Prepared",
            ServingAsIs => "Serving As Is",
            ProductHasBeenRecalled => "Product Has Been Recalled",
            InjectableTradeItem => "Injectable Trade Item",
            ProductHasAnAutoReaderOrAutoTracker => {
                "Product Has an Auto Reader or Auto Tracker"
            }
            AllergenRelevantDataProvided => "Allergen Relevant Data Provided",
            BiomedicalHazardAntineoplastic => "Biomedical Hazard Antineoplastic",
            BiomedicalHazardBiologic => "Biomedical Hazard Biologic",
            BiomedicalHazardCytotoxic => "Biomedical Hazard Cytotoxic",
            BiomedicalHazardRadioactive => "Biomedical Hazard Radioactive",
            ProductContainsLiquid => "Product Contains Liquid",
            AerosolContainer => "Aerosol Container",
            ProductIsSterile => "Product is Sterile",
            CodeUUV => "Generic Name is same as Active Ingredient Name",
            ...
            AbsoluteData => "Absolute Data",
            RoundedData => "Rounded Data",
            ProductContainsWood => "Product Contains Wood",
            Busy => "Busy",
            Excessive => "Excessive",
    ...
    fn from_description(description: &str) -> Option<ConditionIndicatorCode> {
        {
            use ConditionIndicatorCode::*;
            match description {
                ...
                "All Items Price Tagged" => Some(AllItemsPriceTagged),
                "Patient is receiving anti-fungal therapy" => {
                ...
                "Contains Bovine" => Some(ContainsBovine),
                "Contains Di(2-ethylhexyl)phthalate (DEHP)" => Some(Code112),
                "Contains Halogenated Organics" => Some(ContainsHalogenatedOrganics),
                "Implantable Trade Item" => Some(ImplantableTradeItem),
                "Contains Latex" => Some(ContainsLatex),
                "Contains Mercury" => Some(ContainsMercury),
                "Contains Polybutylene Terephthalate (PBT)" => Some(Code117),
                "Contains Porcine" => Some(ContainsPorcine),
                "Contains Polyvinyl Chloride" => Some(ContainsPolyvinylChloride),
                "Single Patient Use Only" => Some(SinglePatientUseOnly),
                "Single Use Only" => Some(SingleUseOnly),
                "Product is Pre-Priced on Package" => Some(ProductIsPrePricedOnPackage),
                "Product Contains Latex" => Some(ProductContainsLatex),
                "Packaging Contains Latex" => Some(PackagingContainsLatex),
                ...
                "Allergen Disclaimer" => Some(AllergenDisclaimer),
                ...
                "Available for Special Order" => Some(AvailableForSpecialOrder),
                "Accept Statement of Limiting Conditions without Changes" => {
                    Some(AcceptStatementOfLimitingConditionsWithoutChanges)
                }
                "Atrophy" => Some(Atrophy),
                ...
                "Buy American Act (BAA) Compliant" => Some(CodeBAA),
                "Building or Mobile Home is in a Coastal Barrier Resources Area" => {
                ...
                "Barcode Symbology Derivable" => Some(BarcodeSymbologyDerivable),
                ...
                "Choking Hazard" => Some(ChokingHazard),
                "Call to Directory Assistance for Co-signer Telephone" => {
                ...
                "Contractor Liable for Discrepancy" => {
                    Some(ContractorLiableForDiscrepancy)
                }
                ...
                "Unrounded Number (Absolute)" => Some(CodeDAA),
                "Rounded Number" => Some(RoundedNumber),
                "Deferment or Forbearance Begin" => Some(DefermentOrForbearanceBegin),
                "Distribution is Restricted" => Some(DistributionIsRestricted),
                "Branded Distribution Product" => Some(BrandedDistributionProduct),
                "Declined" => Some(Declined),
                "Direct to Consumer Delivery" => Some(DirectToConsumerDelivery),
                "Borrower Furnished Demographic Data" => {
                    Some(BorrowerFurnishedDemographicData)
                }
                "Defined Distribution" => Some(DefinedDistribution),
                ...
                "Include in Next Shipment" => Some(IncludeInNextShipment),
                "Promotional Buy" => Some(PromotionalBuy),
                "Same Dye Lot is Required" => Some(SameDyeLotIsRequired),
                "Notice of Construction or Alteration has been Filed" => {
                ...
                "Free from Monosodium Glutamate (MSG)" => Some(CodeFFM),
                "Free From Preservatives" => Some(FreeFromPreservatives),
                ...
                "Fair" => Some(Fair),
                "Federally Reportable" => Some(FederallyReportable),
                ...
                "Gift with Purchase" => Some(GiftWithPurchase),
                ...
                "Product Package Marked with Interleaved 2 of 5 (ITF-14)" => {
                    Some(CodeITF)
                }
                ...
                "Legislative Price Control in Effect" => {
                    Some(LegislativePriceControlInEffect)
                }
                ...
                "Microbiological Aerobic Spores" => Some(MicrobiologicalAerobicSpores),
                "Microbiological Anerobic Spores" => Some(MicrobiologicalAnerobicSpores),
                "Equipment has Modified Configuration" => {
                    Some(EquipmentHasModifiedConfiguration)
                }
                "Marked with a Best Before Date" => Some(MarkedWithABestBeforeDate),
                "Other Mental Condition" => Some(OtherMentalCondition),
                "Made in Canada from Domestic and Imported Ingredients" => {
                    Some(MadeInCanadaFromDomesticAndImportedIngredients)
                }
                "Made in Canada from Imported Ingredients" => {
                    Some(MadeInCanadaFromImportedIngredients)
                }
                "Marketing Time is 4 to 6 Months" => Some(MarketingTimeIs4To6Months),
                "Mild Retardation" => Some(MildRetardation),
                "Trend Reversed" => Some(TrendReversed),
                "Marked with an Expiry Date" => Some(MarkedWithAnExpiryDate),
                "Marked with a Lot Number" => Some(MarkedWithALotNumber),
                ...
                "Marked with a Packing Date" => Some(MarkedWithAPackingDate),
                "Made in a Peanut-Free Facility" => Some(MadeInAPeanutFreeFacility),
                "Eligible Trust" => Some(EligibleTrust),
                "Resale Property" => Some(ResaleProperty),
                "Marked with Production Date" => Some(MarkedWithProductionDate),
                ...
                "Made with New Material" => Some(MadeWithNewMaterial),
                "This Broker Market Analysis is being Completed for Homesale or Buyout" => {
                ...
                "No Artificial Colorings, Dyes, Pigments" => Some(CodeNAC),
                "No Artificial Flavorings" => Some(NoArtificialFlavorings),
                "Neighborhood Predominately Single Family Dwellings" => {
                ...
                "Trade Item Exempt from Nutritional Facts Table" => {
                    Some(TradeItemExemptFromNutritionalFactsTable)
                }
                "Mortgage Points are Customarily Paid by Seller" => {
                ...
                "Nutrition Information Marked on Label" => {
                    Some(NutritionInformationMarkedOnLabel)
                }
                ...
                "Nutrient Relevant Data Provided" => Some(NutrientRelevantDataProvided),
                ...
                "Organic Biodynamic" => Some(OrganicBiodynamic),
                "Mobile Facility" => Some(MobileFacility),
                "Transfer Authorized" => Some(TransferAuthorized),
                "Open Distribution" => Some(OpenDistribution),
                ...
                "Product Is Organic" => Some(ProductIsOrganic),
                "Photographs Taken" => Some(PhotographsTaken),
                "Other Restrictions" => Some(OtherRestrictions),
                "Organic Product 95%" => Some(CodeORG),
                "Organic Product 100%" => Some(CodeORH),
                "Organic Product 70% to 95%" => Some(CodeORI),
                "Organic Product Less Than 70%" => Some(CodeORP),
                ...
                "Patient Is Allowed To Leave Residence" => {
                    Some(PatientIsAllowedToLeaveResidence)
                }
                "Paraplegia" => Some(Paraplegia),
                "Phone Skip Begin" => Some(PhoneSkipBegin),
                "Plan is Attached" => Some(PlanIsAttached),
                "Product Composition Claim is Fresh" => {
                    Some(ProductCompositionClaimIsFresh)
                }
                "Product Contains Probiotic" => Some(ProductContainsProbiotic),
                "Phone Skip Resolved" => Some(PhoneSkipResolved),
                "Product Divisible" => Some(ProductDivisible),
                ...
                "Product Substitution is Not Allowed" => {
                    Some(ProductSubstitutionIsNotAllowed)
                }
                "Personal Property Onsite" => Some(PersonalPropertyOnsite),
                "Purchase Order Carton Consolidation (POCC) for this Carton" => {
                    Some(CodePOC)
                }
                "Purchase Order Carton Consolidation (POCC) for this Shipment" => {
                    Some(CodePOS)
                }
                ...
                "Poor" => Some(Poor),
                "Product of Canada" => Some(ProductOfCanada),
                "Prior Damage" => Some(PriorDamage),
                "Prepared in Canada" => Some(PreparedInCanada),
                "Private Label" => Some(PrivateLabel),
                "Processed in Canada" => Some(ProcessedInCanada),
                "Publication is Included in Sharing" => {
                    Some(PublicationIsIncludedInSharing)
                }
                "Product Substitution is Allowed" => Some(ProductSubstitutionIsAllowed),
                "Product Substitution is Allowed as Specified" => {
                    Some(ProductSubstitutionIsAllowedAsSpecified)
                }
                "Project is Complete" => Some(ProjectIsComplete),
                "Patient Is Homebound" => Some(PatientIsHomebound),
                ...
                "Purchase with Purchase" => Some(PurchaseWithPurchase),
                ...
                "Candidate for U.S. Customs and Border Protection (CBP) Protest" => {
                    Some(CodeQ4)
                }
                ...
                "Referral Required" => Some(ReferralRequired),
                "Debtor has No Executory Contracts or Unexpired Leases" => {
                ...
                "Refined in Canada" => Some(RefinedInCanada),
                "Debtor's Spouse Maintains a Separate Household" => {
                ...
                "RoHS Indicator" => Some(RoHsIndicator),
                "Individual Injured in Performance of Duty" => {
                    Some(IndividualInjuredInPerformanceOfDuty)
                }
                "Retail Price on Trade Item" => Some(RetailPriceOnTradeItem),
                ...
                "Returnable Trade Item" => Some(ReturnableTradeItem),
                ...
                "Product is Pre-Prepared" => Some(ProductIsPrePrepared),
                "Under Treatment" => Some(UnderTreatment),
                "Product is Used As Is" => Some(ProductIsUsedAsIs),
                ...
                "Generic Name is Same As Active Ingredient Name" => {
                    Some(GenericNameIsSameAsActiveIngredientName)
                }
                "Debtor is a Small Business as Defined in 11 U.S.C. Section 101" => {
                ...
                "Sell" => Some(Sell),
                "Manufacturer Product Serial Numbers are Included" => {
                    Some(ManufacturerProductSerialNumbersAreIncluded)
                }
                ...
                "Product is Shakable" => Some(ProductIsShakable),
                ...
                "Threatening Behavior Toward Others" => {
                    Some(ThreateningBehaviorTowardOthers)
                }
                ...
                "Trade Item is Biodegradable" => Some(TradeItemIsBiodegradable),
                "Trade Item is Restricted" => Some(TradeItemIsRestricted),
                ...
                "Product Package Marked with UPC (Universal Product Code)" => {
                    Some(CodeUPC)
                }
                ...
                "Product Subject to United States Patent" => {
                    Some(ProductSubjectToUnitedStatesPatent)
                }
                "Up as Tolerated" => Some(UpAsTolerated),
                "Extent of Audit, if any, Not Indicated" => Some(CodeUU),
                "Single Unit" => Some(SingleUnit),
                "Base Unit" => Some(BaseUnit),
                "Consumer Unit" => Some(ConsumerUnit),
                "Invoice Unit" => Some(InvoiceUnit),
                "Orderable Unit" => Some(OrderableUnit),
                "Shipping Unit" => Some(ShippingUnit),
                "Variable Unit" => Some(VariableUnit),
                "Packaging Marked Returnable" => Some(PackagingMarkedReturnable),
                "Packaging Marked Recyclable" => Some(PackagingMarkedRecyclable),
                "Returnable Product" => Some(ReturnableProduct),
                "Regulatory Identification Pending" => {
                    Some(RegulatoryIdentificationPending)
                }
                "Assembly Required" => Some(AssemblyRequired),
                "Battery Required" => Some(BatteryRequired),
                "Batteries Included" => Some(BatteriesIncluded),
                "Certified Angus Beef" => Some(CertifiedAngusBeef),
                "Serving Has Been Pre Prepared" => Some(ServingHasBeenPrePrepared),
                "Serving As Is" => Some(ServingAsIs),
                "Product Has Been Recalled" => Some(ProductHasBeenRecalled),
                "Injectable Trade Item" => Some(InjectableTradeItem),
                "Product Has an Auto Reader or Auto Tracker" => {
                    Some(ProductHasAnAutoReaderOrAutoTracker)
                }
                "Allergen Relevant Data Provided" => Some(AllergenRelevantDataProvided),
                "Biomedical Hazard Antineoplastic" => {
                    Some(BiomedicalHazardAntineoplastic)
                }
                "Biomedical Hazard Biologic" => Some(BiomedicalHazardBiologic),
                "Biomedical Hazard Cytotoxic" => Some(BiomedicalHazardCytotoxic),
                "Biomedical Hazard Radioactive" => Some(BiomedicalHazardRadioactive),
                "Product Contains Liquid" => Some(ProductContainsLiquid),
                "Aerosol Container" => Some(AerosolContainer),
                "Product is Sterile" => Some(ProductIsSterile),
                "Generic Name is same as Active Ingredient Name" => Some(CodeUUV),
                ...
                "Volume Decrease" => Some(VolumeDecrease),
                "Volume Increase" => Some(VolumeIncrease),
                "Financial Figures are Projected Based on Sales" => {
                ...
                "Absolute Data" => Some(AbsoluteData),
                "Rounded Data" => Some(RoundedData),
                "Product Contains Wood" => Some(ProductContainsWood),
                "Busy" => Some(Busy),
...
impl Serialize for ConditionIndicatorCode {
...
impl<'de> de::Visitor<'de> for Visitor {
    type Value = ConditionIndicatorCode;
    fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        formatter.write_str("Condition Indicator Code")
    }
    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E>
    where
        E: de::Error,
    {
        ConditionIndicatorCode::from_description(v)
            .ok_or_else(|| E::custom(format!("Invalid Condition Indicator Code: {}", v)))
    }
    fn visit_bytes<E>(self, v: &[u8]) -> Result<Self::Value, E>
    where
        E: de::Error,
    {
        ConditionIndicatorCode::from_code(v)
            .ok_or_else(|| E::custom(
                format!(
                    "Invalid Condition Indicator Code: {}", std::str::from_utf8(v)
                    .unwrap()
                ),
            ))
    }
}
impl<'de> Deserialize<'de> for ConditionIndicatorCode {
