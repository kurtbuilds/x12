...
See docs at <https://www.stedi.com/edi/x12/element/1005>*/
...
pub enum HierarchicalStructureCode {
    ...
    Code0029,
    ///0030 - Subscriber, Patient
    Code0030,
    ///0031 - Guarantor, Patient
    Code0031,
    ...
    Code0407,
    ///0450 - Transport Load, Pallet, Mixed Module, Display Shipper, Case, Pack, Inner Pack, Each, Unit of Use
    Code0450,
    ///0451 - Unit of Use, Each, Inner Pack, Pack, Case, Display Shipper, Mixed Module, Pallet, Transport Load
    Code0451,
...
impl HierarchicalStructureCode {
    ...
    pub fn from_code(code: &[u8]) -> Option<HierarchicalStructureCode> {
        ...
        match code {
            ...
            b"0008" => Some(Code0008),
            b"0009" => Some(Code0009),
            ...
            b"0030" => Some(Code0030),
            b"0031" => Some(Code0031),
            ...
            b"0450" => Some(Code0450),
            b"0451" => Some(Code0451),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Code0008 => "Shipment, Order, Tare, Pack",
            Code0009 => "Shipment, Order, Tare, Pack, Batch, Item",
            Code0010 => {
            ...
            Code0030 => "Subscriber, Patient",
            Code0031 => "Guarantor, Patient",
            ...
            Code0450 => {
                "Transport Load, Pallet, Mixed Module, Display Shipper, Case, Pack, Inner Pack, Each, Unit of Use"
            }
            Code0451 => {
                "Unit of Use, Each, Inner Pack, Pack, Case, Display Shipper, Mixed Module, Pallet, Transport Load"
            }
    ...
    fn from_description(description: &str) -> Option<HierarchicalStructureCode> {
        {
            ...
            match description {
                ...
                "Shipment, Order, Tare, Pack" => Some(Code0008),
                "Shipment, Order, Tare, Pack, Batch, Item" => Some(Code0009),
                "Information Source, Information Receiver, Provider of Service, Subscriber, Dependent" => {
                    Some(Code0010)
                }
                "Information Receiver, Information Source, Provider of Service, Subscriber, Dependent" => {
                ...
                "Subscriber, Patient" => Some(Code0030),
                "Guarantor, Patient" => Some(Code0031),
