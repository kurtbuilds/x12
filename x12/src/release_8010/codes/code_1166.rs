...
See docs at <https://www.stedi.com/edi/x12/element/1166>*/
...
pub enum ContractTypeCode {
    ...
    ///LH - Labor Hours
    LaborHours,
    ///LM - Legislative Mandated Rate Structure
    LegislativeMandatedRateStructure,
...
impl ContractTypeCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                LevelOfEffort => "LE",
                LaborHours => "LH",
                LegislativeMandatedRateStructure => "LM",
    ...
    pub fn from_code(code: &[u8]) -> Option<ContractTypeCode> {
        ...
        match code {
            ...
            b"LM" => Some(LegislativeMandatedRateStructure),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            LegislativeMandatedRateStructure => "Legislative Mandated Rate Structure",
    ...
    fn from_description(description: &str) -> Option<ContractTypeCode> {
        {
            ...
            match description {
                ...
                "Legislative Mandated Rate Structure" => {
                    Some(LegislativeMandatedRateStructure)
                }
