...
See docs at <https://www.stedi.com/edi/x12/element/687>*/
...
pub enum ClassOfTradeCode {
    ...
    ///JB - Jobber
    Jobber,
    ///K4 - Distributor Authorized
    DistributorAuthorized,
    ///K5 - Distributor Published
    DistributorPublished,
    ///KH - Maintenance Repair and Operations (MRO)
    CodeKH,
    ///KN - System Integrator
    SystemIntegrator,
    ///KO - End User Suggested
    EndUserSuggested,
    ///LC - Long-term Care
    LongTermCare,
    ///MC - Managed Care
...
impl ClassOfTradeCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                Jobber => "JB",
                DistributorAuthorized => "K4",
                DistributorPublished => "K5",
                CodeKH => "KH",
                SystemIntegrator => "KN",
                EndUserSuggested => "KO",
                LongTermCare => "LC",
    ...
    pub fn from_code(code: &[u8]) -> Option<ClassOfTradeCode> {
        ...
        match code {
            ...
            b"JB" => Some(Jobber),
            b"K4" => Some(DistributorAuthorized),
            b"K5" => Some(DistributorPublished),
            b"KH" => Some(CodeKH),
            b"KN" => Some(SystemIntegrator),
            b"KO" => Some(EndUserSuggested),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Jobber => "Jobber",
            DistributorAuthorized => "Distributor Authorized",
            DistributorPublished => "Distributor Published",
            CodeKH => "Maintenance Repair and Operations (MRO)",
            SystemIntegrator => "System Integrator",
            EndUserSuggested => "End User Suggested",
            ...
            Resale => "Resale",
            HealthcareProducts => "Healthcare Products",
            Services => "Services",
            Support => "Support",
    ...
    fn from_description(description: &str) -> Option<ClassOfTradeCode> {
        {
            ...
            match description {
                ...
                "Jobber" => Some(Jobber),
                "Distributor Authorized" => Some(DistributorAuthorized),
                "Distributor Published" => Some(DistributorPublished),
                "Maintenance Repair and Operations (MRO)" => Some(CodeKH),
                "System Integrator" => Some(SystemIntegrator),
                "End User Suggested" => Some(EndUserSuggested),
                ...
                "Resale" => Some(Resale),
                "Healthcare Products" => Some(HealthcareProducts),
