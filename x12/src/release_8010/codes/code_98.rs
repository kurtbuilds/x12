...
pub enum EntityIdentifierCode {
    ...
    ///4B - Burn Care Unit
    BurnCareUnit,
    ///4C - Cardiac Catheterization Laboratory
    CardiacCatheterizationLaboratory,
    ...
    JointAnnuitantOwner,
    ///ABJ - Joint Owner Annuitant Payer
    JointOwnerAnnuitantPayer,
    ///ABK - Joint Owner Joint Annuitant
    JointOwnerJointAnnuitant,
    ///ABL - Joint Owner Joint Annuitant Payer
    JointOwnerJointAnnuitantPayer,
    ///ABM - Joint Owner Payer
    JointOwnerPayer,
    ///ABN - Acronym
    Acronym,
    ///ABO - New Address
...
See U.S. Internal Revenue Code Chapter 1, Subchapter F, Part 1, Section 501(c)*/
    ...
    ///KCA - Kosher Certification Agency
    KosherCertificationAgency,
    ///KD - Proposer
    Proposer,
    ///KE - Contact Office
    ContactOffice,
    ...
    OrganicAccreditedCertifyingAgency,
    ///OB - Ordered By
    OrderedBy,
    ...
    PartyEstablishingBillbackFrequency,
    ///PER - Party Establishing Price Changes
    PartyEstablishingPriceChanges,
    ...
    ///VIC - Victim
    Victim,
    ///VJ - Owner Joint Annuitant Payer
    OwnerJointAnnuitantPayer,
...
impl EntityIdentifierCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                BurnCareUnit => "4B",
                CardiacCatheterizationLaboratory => "4C",
                ...
                JointOwnerAnnuitantPayer => "ABJ",
                JointOwnerJointAnnuitant => "ABK",
                JointOwnerJointAnnuitantPayer => "ABL",
                JointOwnerPayer => "ABM",
                Acronym => "ABN",
                NewAddress => "ABO",
                Chairperson => "ABP",
                ...
                Complainant => "COM",
                CorrectedPatient => "COP",
                CorrectedName => "COR",
                CorrectedSubscriber => "COS",
                ...
                LocationOfContainerStuffing => "L4",
                Contact => "L5",
                HeadOffice => "L8",
                ...
                DeliveryLocation => "MQ",
                AssociatedDeliveryLocation => "MQA",
                ...
                OrganicAccreditedCertifyingAgency => "OAA",
                OrderedBy => "OB",
                OperatorBuyingGroup => "OBG",
                OriginCarrier => "OC",
                ...
                Payee => "PE",
                PartyEstablishingBillbackFrequency => "PEB",
                PartyEstablishingPriceChanges => "PER",
    ...
    pub fn from_code(code: &[u8]) -> Option<EntityIdentifierCode> {
        ...
        match code {
            ...
            b"4C" => Some(CardiacCatheterizationLaboratory),
            ...
            b"5B" => Some(HistopathologyLaboratory),
            b"5C" => Some(BloodBank),
            ...
            b"ABJ" => Some(JointOwnerAnnuitantPayer),
            b"ABK" => Some(JointOwnerJointAnnuitant),
            b"ABL" => Some(JointOwnerJointAnnuitantPayer),
            b"ABM" => Some(JointOwnerPayer),
            b"ABN" => Some(Acronym),
            ...
            b"BR" => Some(Broker),
            b"BRA" => Some(NationalAccount),
            b"BRB" => Some(CustomerSegment),
            b"BRN" => Some(BrandName),
            b"BRO" => Some(BrandOwner),
            ...
            b"DBG" => Some(DistributorBuyingGroup),
            ...
            b"KCA" => Some(KosherCertificationAgency),
            b"KD" => Some(Proposer),
            ...
            b"L4" => Some(LocationOfContainerStuffing),
            b"L5" => Some(Contact),
            ...
            b"M2A" => Some(AssociatedReceiptLocation),
            ...
            b"MQA" => Some(AssociatedDeliveryLocation),
            ...
            b"OAA" => Some(OrganicAccreditedCertifyingAgency),
            b"OB" => Some(OrderedBy),
            b"OBG" => Some(OperatorBuyingGroup),
            ...
            b"OO" => Some(CodeOO),
            b"OOP" => Some(OtherOperatingPhysician),
            ...
            b"PE" => Some(Payee),
            b"PEB" => Some(PartyEstablishingBillbackFrequency),
            b"PER" => Some(PartyEstablishingPriceChanges),
            ...
            b"VIC" => Some(Victim),
            b"VJ" => Some(OwnerJointAnnuitantPayer),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            CardiacCatheterizationLaboratory => "Cardiac Catheterization Laboratory",
            ...
            HistopathologyLaboratory => "Histopathology Laboratory",
            ...
            JointOwnerAnnuitantPayer => "Joint Owner Annuitant Payer",
            JointOwnerJointAnnuitant => "Joint Owner Joint Annuitant",
            JointOwnerJointAnnuitantPayer => "Joint Owner Joint Annuitant Payer",
            JointOwnerPayer => "Joint Owner Payer",
            Acronym => "Acronym",
            ...
            CorrectedPatient => "Corrected Patient",
            CorrectedName => "Corrected Name",
            CorrectedSubscriber => "Corrected Subscriber",
            ...
            DistributorBuyingGroup => "Distributor Buying Group",
            ...
            GradeCodeAgency => "Grade Code Agency",
            Guardian => "Guardian",
            ...
            CodeISF => "Importer Security Filing (ISF) Importer",
            ...
            KosherCertificationAgency => "Kosher Certification Agency",
            Proposer => "Proposer",
            ...
            LocationOfContainerStuffing => "Location of Container Stuffing",
            Contact => "Contact",
            ...
            AssociatedReceiptLocation => "Associated Receipt Location",
            ...
            AssociatedDeliveryLocation => "Associated Delivery Location",
            ...
            MexicanTax => "Mexican Tax Identifier",
            ...
            OrganicAccreditedCertifyingAgency => "Organic Accredited Certifying Agency",
            OrderedBy => "Ordered By",
            OperatorBuyingGroup => "Operator Buying Group",
            ...
            OtherOperatingPhysician => "Other Operating Physician",
            ...
            Payee => "Payee",
            PartyEstablishingBillbackFrequency => "Party Establishing Billback Frequency",
            PartyEstablishingPriceChanges => "Party Establishing Price Changes",
            ...
            PartyFilingPriorNotice => "Party Filing Prior Notice",
            PartyToReceiveInvoiceForGoodsOrServices => {
                "Party to Receive Invoice for Goods or Services"
            }
            Property => "Property",
            PastPerformanceContact => "Past Performance Contact",
            PartyProvidingEquipment => "Party Providing Equipment",
            PersonForWhoseBenefitPropertyWasSeized => {
            ...
            PayToPlanName => "Pay-to Plan Name",
            ...
            CodeSL1 => "Pipeline Segment Defined by 1 Location (or First of 2 Locations)",
            CodeSL2 => {
                "Pipeline Segment Defined by 2 Locations (or Second of 2 Locations)"
            }
            ...
            AnnuitantPayer => "Annuitant Payer",
            ...
            OwnerAnnuitantPayer => "Owner Annuitant Payer",
            ...
            Victim => "Victim",
            OwnerJointAnnuitantPayer => "Owner Joint Annuitant Payer",
            ...
            Creditor => "Creditor",
            InLandMexicanBroker => "In-land Mexican Broker",
            ...
            MinimumRoyaltyPayer => "Minimum Royalty Payer",
            Zone => "Zone",
    ...
    fn from_description(description: &str) -> Option<EntityIdentifierCode> {
        {
            ...
            match description {
                ...
                "Cardiac Catheterization Laboratory" => {
                    Some(CardiacCatheterizationLaboratory)
                }
                ...
                "Histopathology Laboratory" => Some(HistopathologyLaboratory),
                ...
                "Joint Owner Annuitant Payer" => Some(JointOwnerAnnuitantPayer),
                "Joint Owner Joint Annuitant" => Some(JointOwnerJointAnnuitant),
                "Joint Owner Joint Annuitant Payer" => {
                    Some(JointOwnerJointAnnuitantPayer)
                }
                "Joint Owner Payer" => Some(JointOwnerPayer),
                ...
                "Bank" => Some(Bank),
                "Booking Party" => Some(BookingParty),
                ...
                "Broker" => Some(Broker),
                "National Account" => Some(NationalAccount),
                "Customer Segment" => Some(CustomerSegment),
                "Brand Name" => Some(BrandName),
                "Brand Owner" => Some(BrandOwner),
                ...
                "Corrected Patient" => Some(CorrectedPatient),
                "Corrected Name" => Some(CorrectedName),
                "Corrected Subscriber" => Some(CorrectedSubscriber),
                ...
                "Admitting Physician" => Some(AdmittingPhysician),
                "Driver" => Some(Driver),
                ...
                "Distributor Buying Group" => Some(DistributorBuyingGroup),
                ...
                "Grade Code Agency" => Some(GradeCodeAgency),
                ...
                "Importer of Record" => Some(ImporterOfRecord),
                ...
                "Importer Security Filing (ISF) Importer" => Some(CodeISF),
                ...
                "Kosher Certification Agency" => Some(KosherCertificationAgency),
                ...
                "Location of Container Stuffing" => Some(LocationOfContainerStuffing),
                ...
                "Associated Receipt Location" => Some(AssociatedReceiptLocation),
                ...
                "Master Broker" => Some(MasterBroker),
                ...
                "Associated Delivery Location" => Some(AssociatedDeliveryLocation),
                ...
                "Mexican Tax Identifier" => Some(MexicanTax),
                ...
                "Organic Accredited Certifying Agency" => {
                    Some(OrganicAccreditedCertifyingAgency)
                }
                "Ordered By" => Some(OrderedBy),
                "Operator Buying Group" => Some(OperatorBuyingGroup),
                ...
                "Other Operating Physician" => Some(OtherOperatingPhysician),
                ...
                "Payee" => Some(Payee),
                "Party Establishing Billback Frequency" => {
                    Some(PartyEstablishingBillbackFrequency)
                }
                "Party Establishing Price Changes" => Some(PartyEstablishingPriceChanges),
                ...
                "Party Filing Prior Notice" => Some(PartyFilingPriorNotice),
                "Party to Receive Invoice for Goods or Services" => {
                    Some(PartyToReceiveInvoiceForGoodsOrServices)
                }
                "Property" => Some(Property),
                "Past Performance Contact" => Some(PastPerformanceContact),
                "Party Providing Equipment" => Some(PartyProvidingEquipment),
                "Person for Whose Benefit Property was Seized" => {
                ...
                "Pay-to Plan Name" => Some(PayToPlanName),
                ...
                "Redistributor" => Some(Redistributor),
                "Repacker" => Some(Repacker),
                ...
                "Selling Group" => Some(SellingGroup),
                ...
                "Pipeline Segment Defined by 1 Location (or First of 2 Locations)" => {
                    Some(CodeSL1)
                }
                "Pipeline Segment Defined by 2 Locations (or Second of 2 Locations)" => {
                    Some(CodeSL2)
                ...
                "Annuitant Payer" => Some(AnnuitantPayer),
                ...
                "Owner Annuitant Payer" => Some(OwnerAnnuitantPayer),
                ...
                "Victim" => Some(Victim),
                "Owner Joint Annuitant Payer" => Some(OwnerJointAnnuitantPayer),
                ...
                "In-land Mexican Broker" => Some(InLandMexicanBroker),
                ...
                "Minimum Royalty Payer" => Some(MinimumRoyaltyPayer),
                "Zone" => Some(Zone),
