...
pub enum CodeCategory {
    ...
    ///EM - Supplier Detail
    SupplierDetail,
    ///EP - Early & Periodic Screening, Diagnosis and Treatment (EPSDT) Claim
    CodeEP,
...
impl CodeCategory {
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            CodeEP => "Early & Periodic Screening, Diagnosis and Treatment (EPSDT) Claim",
    ...
    fn from_description(description: &str) -> Option<CodeCategory> {
        {
            ...
            match description {
                ...
                "Early & Periodic Screening, Diagnosis and Treatment (EPSDT) Claim" => {
                    Some(CodeEP)
                }
