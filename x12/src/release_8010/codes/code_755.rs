...
pub enum ReportTypeCode {
    ...
    DoctorsFirstReportOfInjury,
    ///J2 - Supplemental Medical Report
    SupplementalMedicalReport,
    ///J3 - Medical Permanent Impairment
    MedicalPermanentImpairment,
    ...
    LocationReconciliationHistoryNotificationReport,
    ...
    OrderToDeliveryCycleTime,
    ///YK - Out of Stock
    OutOfStock,
    ///YL - Retail Gross Profit Margin
    RetailGrossProfitMargin,
    ///YM - Sales Growth
    SalesGrowth,
    ///YN - Service Level Fill Rate
    ServiceLevelFillRate,
    ///YP - Share
    Share,
    ///YQ - Unsaleables
    Unsaleables,
    ///YR - Retail Item Gross Margin
    RetailItemGrossMargin,
...
impl ReportTypeCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                InspectionResult => "IU",
                Invoice => "IV",
                DoctorsFirstReportOfInjury => "J1",
                SupplementalMedicalReport => "J2",
                MedicalPermanentImpairment => "J3",
                MedicalLegalReport => "J4",
                VocationalReport => "J5",
                WorkStatusReport => "J6",
                ConsultationReport => "J7",
                PermanentDisability => "J8",
                ItemizedStatement => "J9",
                ...
                LegalizedInvoice => "LI",
                LocationReconciliationHistoryNotificationReport => "LN",
                CodeLO => "LO",
                LaborPlan => "LP",
                CodeLR => "LR",
                ...
                FinishedGoodsInventoryCover => "YA",
                ForecastAccuracy => "YB",
                InvoiceAccuracy => "YC",
                ItemDataSynchronization => "YD",
                ItemMasterDataAccuracy => "YE",
                Markdown => "YF",
                OnTimeDelivery => "YG",
                OnTimePayment => "YH",
                OrderItemQuantityChange => "YI",
                OrderToDeliveryCycleTime => "YJ",
                OutOfStock => "YK",
                RetailGrossProfitMargin => "YL",
                SalesGrowth => "YM",
                ServiceLevelFillRate => "YN",
                Share => "YP",
                Unsaleables => "YQ",
                RetailItemGrossMargin => "YR",
    ...
    pub fn from_code(code: &[u8]) -> Option<ReportTypeCode> {
        ...
        match code {
            ...
            b"IV" => Some(Invoice),
            b"J1" => Some(DoctorsFirstReportOfInjury),
            b"J2" => Some(SupplementalMedicalReport),
            b"J3" => Some(MedicalPermanentImpairment),
            b"J4" => Some(MedicalLegalReport),
            b"J5" => Some(VocationalReport),
            b"J6" => Some(WorkStatusReport),
            b"J7" => Some(ConsultationReport),
            b"J8" => Some(PermanentDisability),
            b"J9" => Some(ItemizedStatement),
            ...
            b"LN" => Some(LocationReconciliationHistoryNotificationReport),
            b"LO" => Some(CodeLO),
            b"LP" => Some(LaborPlan),
            b"LR" => Some(CodeLR),
            ...
            b"P9" => Some(ProvisioningSupplySupport),
            ...
            b"YA" => Some(FinishedGoodsInventoryCover),
            b"YB" => Some(ForecastAccuracy),
            b"YC" => Some(InvoiceAccuracy),
            b"YD" => Some(ItemDataSynchronization),
            b"YE" => Some(ItemMasterDataAccuracy),
            b"YF" => Some(Markdown),
            b"YG" => Some(OnTimeDelivery),
            b"YH" => Some(OnTimePayment),
            b"YI" => Some(OrderItemQuantityChange),
            b"YJ" => Some(OrderToDeliveryCycleTime),
            b"YK" => Some(OutOfStock),
            b"YL" => Some(RetailGrossProfitMargin),
            b"YM" => Some(SalesGrowth),
            b"YN" => Some(ServiceLevelFillRate),
            b"YP" => Some(Share),
            b"YQ" => Some(Unsaleables),
            b"YR" => Some(RetailItemGrossMargin),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            BillbackReport => "Billback Report",
            ...
            Invoice => "Invoice",
            DoctorsFirstReportOfInjury => "Doctor's First Report of Injury",
            SupplementalMedicalReport => "Supplemental Medical Report",
            MedicalPermanentImpairment => "Medical Permanent Impairment",
            MedicalLegalReport => "Medical Legal Report",
            VocationalReport => "Vocational Report",
            WorkStatusReport => "Work Status Report",
            ...
            LocationReconciliationHistoryNotificationReport => {
                "Location Reconciliation History Notification Report"
            }
            ...
            ProvisioningSupplySupport => "Provisioning - Supply Support Information",
            ...
            FinishedGoodsInventoryCover => "Finished Goods Inventory Cover",
            ForecastAccuracy => "Forecast Accuracy",
            InvoiceAccuracy => "Invoice Accuracy",
            ItemDataSynchronization => "Item Data Synchronization",
            ItemMasterDataAccuracy => "Item Master Data Accuracy",
            Markdown => "Markdown",
            OnTimeDelivery => "On Time Delivery",
            OnTimePayment => "On Time Payment",
            OrderItemQuantityChange => "Order Item Quantity Change",
            OrderToDeliveryCycleTime => "Order to Delivery Cycle Time",
            OutOfStock => "Out of Stock",
            RetailGrossProfitMargin => "Retail Gross Profit Margin",
            SalesGrowth => "Sales Growth",
            ServiceLevelFillRate => "Service Level Fill Rate",
            Share => "Share",
            Unsaleables => "Unsaleables",
            RetailItemGrossMargin => "Retail Item Gross Margin",
    ...
    fn from_description(description: &str) -> Option<ReportTypeCode> {
        {
            ...
            match description {
                ...
                "Billback Report" => Some(BillbackReport),
                ...
                "Doctor's First Report of Injury" => Some(DoctorsFirstReportOfInjury),
                "Supplemental Medical Report" => Some(SupplementalMedicalReport),
                "Medical Permanent Impairment" => Some(MedicalPermanentImpairment),
                "Medical Legal Report" => Some(MedicalLegalReport),
                "Vocational Report" => Some(VocationalReport),
                "Work Status Report" => Some(WorkStatusReport),
                "Consultation Report" => Some(ConsultationReport),
                "Permanent Disability" => Some(PermanentDisability),
                "Itemized Statement" => Some(ItemizedStatement),
                ...
                "Location Reconciliation History Notification Report" => {
                    Some(LocationReconciliationHistoryNotificationReport)
                }
                ...
                "Provisioning - Supply Support Information" => {
                    Some(ProvisioningSupplySupport)
                }
                ...
                "Finished Goods Inventory Cover" => Some(FinishedGoodsInventoryCover),
                "Forecast Accuracy" => Some(ForecastAccuracy),
                "Invoice Accuracy" => Some(InvoiceAccuracy),
                "Item Data Synchronization" => Some(ItemDataSynchronization),
                "Item Master Data Accuracy" => Some(ItemMasterDataAccuracy),
                "Markdown" => Some(Markdown),
                "On Time Delivery" => Some(OnTimeDelivery),
                "On Time Payment" => Some(OnTimePayment),
                "Order Item Quantity Change" => Some(OrderItemQuantityChange),
                "Order to Delivery Cycle Time" => Some(OrderToDeliveryCycleTime),
                "Out of Stock" => Some(OutOfStock),
                "Retail Gross Profit Margin" => Some(RetailGrossProfitMargin),
                "Sales Growth" => Some(SalesGrowth),
                "Service Level Fill Rate" => Some(ServiceLevelFillRate),
                "Share" => Some(Share),
                "Unsaleables" => Some(Unsaleables),
                "Retail Item Gross Margin" => Some(RetailItemGrossMargin),
