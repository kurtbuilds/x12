...
See docs at <https://www.stedi.com/edi/x12/element/1029>*/
...
pub enum ClaimStatusCode {
    ...
    ///31 - Not Our Claim, Unable to Forward
    Code31,
    ///32 - Reversal of Previous Payment for Primary Claim
    ReversalOfPreviousPaymentForPrimaryClaim,
    ///33 - Reversal of Previous Payment for Secondary Claim
    ReversalOfPreviousPaymentForSecondaryClaim,
    ///34 - Reversal of Previous Payment of Tertiary Claim
    ReversalOfPreviousPaymentOfTertiaryClaim,
    ///35 - Patient/Subscriber Not Recognized
    PatientSubscriberNotRecognized,
    ///AD - Additional
    Additional,
    ///AP - Appealed
    Appealed,
...
impl ClaimStatusCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                Code31 => "31",
                ReversalOfPreviousPaymentForPrimaryClaim => "32",
                ReversalOfPreviousPaymentForSecondaryClaim => "33",
                ReversalOfPreviousPaymentOfTertiaryClaim => "34",
                PatientSubscriberNotRecognized => "35",
                Additional => "AD",
                Appealed => "AP",
    ...
    pub fn from_code(code: &[u8]) -> Option<ClaimStatusCode> {
        ...
        match code {
            ...
            b"31" => Some(Code31),
            b"32" => Some(ReversalOfPreviousPaymentForPrimaryClaim),
            b"33" => Some(ReversalOfPreviousPaymentForSecondaryClaim),
            b"34" => Some(ReversalOfPreviousPaymentOfTertiaryClaim),
            b"35" => Some(PatientSubscriberNotRecognized),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Code31 => "Not Our Claim, Unable to Forward",
            ReversalOfPreviousPaymentForPrimaryClaim => {
            ...
            PatientSubscriberNotRecognized => "Patient/Subscriber Not Recognized",
    ...
    fn from_description(description: &str) -> Option<ClaimStatusCode> {
        {
            ...
            match description {
                ...
                "Not Our Claim, Unable to Forward" => Some(Code31),
                "Reversal of Previous Payment for Primary Claim" => {
                    Some(ReversalOfPreviousPaymentForPrimaryClaim)
                }
                "Reversal of Previous Payment for Secondary Claim" => {
                    Some(ReversalOfPreviousPaymentForSecondaryClaim)
                }
                "Reversal of Previous Payment of Tertiary Claim" => {
                    Some(ReversalOfPreviousPaymentOfTertiaryClaim)
                }
                "Patient/Subscriber Not Recognized" => {
                    Some(PatientSubscriberNotRecognized)
                }
