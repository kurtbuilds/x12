...
pub enum AgencyQualifierCode {
    ...
    ///GI - North American Energy Standards Board
    NorthAmericanEnergyStandardsBoard,
    ...
    ///K0 - GS1 Canada ECCnet I&V
    CodeK0,
    ///K1 - Aquaculture Stewardship Council (ASC)
    CodeK1,
    ///K2 - Association Quebecoise des Allergies Alimentaires (AQAA)
    CodeK2,
    ///K3 - Canadian Food Inspection Agency (CFIA) Organic Regime (Certification) Agency
    CodeK3,
    ///K4 - Earth Island Institute
    EarthIslandInstitute,
    ///K5 - GS1 Canada ECCnet Registry
    Gs1CanadaEcCnetRegistry,
    ///K6 - Heart and Stroke Foundation of Canada
    HeartAndStrokeFoundationOfCanada,
    ///K7 - Marine Stewardship Council (MSC)
    CodeK7,
    ///K8 - Ontario Ministry of Agriculture and Food
    OntarioMinistryOfAgricultureAndFood,
    ///K9 - The Global Aquaculture Alliance
...
impl AgencyQualifierCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                NorthAmericanEnergyStandardsBoard => "GI",
                CodeGS => "GS",
                ...
                CodeK2 => "K2",
                CodeK3 => "K3",
                EarthIslandInstitute => "K4",
                Gs1CanadaEcCnetRegistry => "K5",
                HeartAndStrokeFoundationOfCanada => "K6",
                CodeK7 => "K7",
                OntarioMinistryOfAgricultureAndFood => "K8",
                TheGlobalAquacultureAlliance => "K9",
    ...
    pub fn from_code(code: &[u8]) -> Option<AgencyQualifierCode> {
        ...
        match code {
            ...
            b"GI" => Some(NorthAmericanEnergyStandardsBoard),
            b"GS" => Some(CodeGS),
            ...
            b"K2" => Some(CodeK2),
            b"K3" => Some(CodeK3),
            b"K4" => Some(EarthIslandInstitute),
            b"K5" => Some(Gs1CanadaEcCnetRegistry),
            b"K6" => Some(HeartAndStrokeFoundationOfCanada),
            b"K7" => Some(CodeK7),
            b"K8" => Some(OntarioMinistryOfAgricultureAndFood),
            b"K9" => Some(TheGlobalAquacultureAlliance),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            NorthAmericanEnergyStandardsBoard => "North American Energy Standards Board",
            ...
            CodeK0 => "GS1 Canada ECCnet I&V",
            CodeK1 => "Aquaculture Stewardship Council (ASC)",
            CodeK2 => "Association Quebecoise des Allergies Alimentaires (AQAA)",
            CodeK3 => {
                "Canadian Food Inspection Agency (CFIA) Organic Regime (Certification) Agency"
            }
            EarthIslandInstitute => "Earth Island Institute",
            Gs1CanadaEcCnetRegistry => "GS1 Canada ECCnet Registry",
            HeartAndStrokeFoundationOfCanada => "Heart and Stroke Foundation of Canada",
            CodeK7 => "Marine Stewardship Council (MSC)",
            OntarioMinistryOfAgricultureAndFood => {
                "Ontario Ministry of Agriculture and Food"
            }
            TheGlobalAquacultureAlliance => "The Global Aquaculture Alliance",
            ...
            CodePI => "Society of the Plastics Industry (SPI)",
            ...
            CodeUE => "Universal Descriptor Exchange (UDEX)",
    ...
    fn from_description(description: &str) -> Option<AgencyQualifierCode> {
        {
            ...
            match description {
                ...
                "GS1 US, Inc." => Some(CodeFD),
                "GS1 Canada" => Some(Gs1Canada),
                ...
                "North American Energy Standards Board" => {
                    Some(NorthAmericanEnergyStandardsBoard)
                }
                ...
                "GS1 Canada ECCnet I&V" => Some(CodeK0),
                "Aquaculture Stewardship Council (ASC)" => Some(CodeK1),
                ...
                "Earth Island Institute" => Some(EarthIslandInstitute),
                "GS1 Canada ECCnet Registry" => Some(Gs1CanadaEcCnetRegistry),
                "Heart and Stroke Foundation of Canada" => {
                    Some(HeartAndStrokeFoundationOfCanada)
                }
                "Marine Stewardship Council (MSC)" => Some(CodeK7),
                "Ontario Ministry of Agriculture and Food" => {
                    Some(OntarioMinistryOfAgricultureAndFood)
                }
                "The Global Aquaculture Alliance" => Some(TheGlobalAquacultureAlliance),
                ...
                "Society of the Plastics Industry (SPI)" => Some(CodePI),
                ...
                "Universal Descriptor Exchange (UDEX)" => Some(CodeUE),
