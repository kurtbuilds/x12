...
pub enum AmbulanceTransportReasonCode {
    ...
    ///G - Patient Was Not Transported
    PatientWasNotTransported,
}
impl AmbulanceTransportReasonCode {
    ...
    pub fn from_code(code: &[u8]) -> Option<AmbulanceTransportReasonCode> {
        ...
        match code {
            ...
            b"G" => Some(PatientWasNotTransported),
            _ => None,
        }
    }
    fn description(&self) -> &str {
        ...
        match self {
            ...
            PatientWasNotTransported => "Patient Was Not Transported",
        }
    }
    fn from_description(description: &str) -> Option<AmbulanceTransportReasonCode> {
        {
            ...
            match description {
                ...
                "Patient Was Not Transported" => Some(PatientWasNotTransported),
                _ => None,
            }
        }
    }
