...
pub enum BasisOfUnitPriceCode {
    ...
    ///NT - Net
    Net,
    ///P1 - Price per 1000 Meter
    PricePer1000Meter,
    ///P2 - Price per Centimeter
    PricePerCentimeter,
    ///P3 - Price per Decimeter
    PricePerDecimeter,
    ///P4 - Price per Hectometer
    PricePerHectometer,
    ///P5 - Price per Kilometer
    PricePerKilometer,
    ///P6 - Price per Millimeter
    PricePerMillimeter,
    ///P7 - Price per Meter
    PricePerMeter,
    ...
    ///SO - Sales Amount On Invoice
    SalesAmountOnInvoice,
    ///SR - Suggested Retail
    SuggestedRetail,
    ///ST - Standard
    Standard,
...
impl BasisOfUnitPriceCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                Net => "NT",
                PricePer1000Meter => "P1",
                PricePerCentimeter => "P2",
                PricePerDecimeter => "P3",
                PricePerHectometer => "P4",
                PricePerKilometer => "P5",
                PricePerMillimeter => "P6",
                PricePerMeter => "P7",
    ...
    pub fn from_code(code: &[u8]) -> Option<BasisOfUnitPriceCode> {
        ...
        match code {
            ...
            b"NT" => Some(Net),
            b"P1" => Some(PricePer1000Meter),
            b"P2" => Some(PricePerCentimeter),
            b"P3" => Some(PricePerDecimeter),
            b"P4" => Some(PricePerHectometer),
            b"P5" => Some(PricePerKilometer),
            b"P6" => Some(PricePerMillimeter),
            b"P7" => Some(PricePerMeter),
            ...
            b"SO" => Some(SalesAmountOnInvoice),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            Catalog => "Catalog",
            ContracteeCost => "Contractee Cost",
            ...
            Net => "Net",
            PricePer1000Meter => "Price per 1000 Meter",
            PricePerCentimeter => "Price per Centimeter",
            PricePerDecimeter => "Price per Decimeter",
            PricePerHectometer => "Price per Hectometer",
            PricePerKilometer => "Price per Kilometer",
            PricePerMillimeter => "Price per Millimeter",
            ...
            SalesAmountOnInvoice => "Sales Amount On Invoice",
    ...
    fn from_description(description: &str) -> Option<BasisOfUnitPriceCode> {
        {
            ...
            match description {
                ...
                "Contractee Cost" => Some(ContracteeCost),
                ...
                "Inventory Cost Basis" => Some(InventoryCostBasis),
                "Price with Government Furnished Property" => {
                ...
                "Net" => Some(Net),
                "Price per 1000 Meter" => Some(PricePer1000Meter),
                "Price per Centimeter" => Some(PricePerCentimeter),
                "Price per Decimeter" => Some(PricePerDecimeter),
                "Price per Hectometer" => Some(PricePerHectometer),
                "Price per Kilometer" => Some(PricePerKilometer),
                "Price per Millimeter" => Some(PricePerMillimeter),
                "Price per Meter" => Some(PricePerMeter),
                ...
                "Sales Amount On Invoice" => Some(SalesAmountOnInvoice),
