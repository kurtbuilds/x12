...
impl ReleaseOfInformationCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                CodeN => "N",
                OnFileAtPayerOrAtPlanSponsor => "O",
                CodeY => "Y",
            }
        }
    }
    pub fn from_code(code: &[u8]) -> Option<ReleaseOfInformationCode> {
        ...
        match code {
            ...
            b"N" => Some(CodeN),
            b"O" => Some(OnFileAtPayerOrAtPlanSponsor),
            b"Y" => Some(CodeY),
            _ => None,
        }
    }
    fn description(&self) -> &str {
        ...
        match self {
            ...
            OnFileAtPayerOrAtPlanSponsor => "On file at Payer or at Plan Sponsor",
            CodeY => {
    ...
    fn from_description(description: &str) -> Option<ReleaseOfInformationCode> {
        {
            ...
            match description {
                ...
                "On file at Payer or at Plan Sponsor" => {
                    Some(OnFileAtPayerOrAtPlanSponsor)
                }
                "Yes, Provider has a Signed Statement Permitting Release of Medical Billing Data Related to a Claim" => {
                    Some(CodeY)
                }
