...
pub enum UnitDoseCode {
    ...
    ///9 - Pharmacy Unit Dose Patient Compliance Packaging
    PharmacyUnitDosePatientCompliancePackaging,
    ///A - Pharmacy Multi-Drug Patient Compliance Packaging
    PharmacyMultiDrugPatientCompliancePackaging,
    ///B - Remote Device Unit Dose
    RemoteDeviceUnitDose,
    ///C - Remote Device Multi-Drug Compliance
    RemoteDeviceMultiDrugCompliance,
    ///D - Manufacturer Unit of Use Package (not unit dose)
    CodeD,
    ///Z - Mutually Defined
    MutuallyDefined,
}
impl UnitDoseCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                PharmacyUnitDosePatientCompliancePackaging => "9",
                PharmacyMultiDrugPatientCompliancePackaging => "A",
                RemoteDeviceUnitDose => "B",
                RemoteDeviceMultiDrugCompliance => "C",
                CodeD => "D",
                MutuallyDefined => "Z",
            }
        }
    ...
    pub fn from_code(code: &[u8]) -> Option<UnitDoseCode> {
        ...
        match code {
            ...
            b"9" => Some(PharmacyUnitDosePatientCompliancePackaging),
            b"A" => Some(PharmacyMultiDrugPatientCompliancePackaging),
            b"B" => Some(RemoteDeviceUnitDose),
            b"C" => Some(RemoteDeviceMultiDrugCompliance),
            b"D" => Some(CodeD),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            RemoteDeviceUnitDose => "Remote Device Unit Dose",
            RemoteDeviceMultiDrugCompliance => "Remote Device Multi-Drug Compliance",
            CodeD => "Manufacturer Unit of Use Package (not unit dose)",
    ...
    fn from_description(description: &str) -> Option<UnitDoseCode> {
        {
            ...
            match description {
                ...
                "Pharmacy Unit Dose Patient Compliance Packaging" => {
                    Some(PharmacyUnitDosePatientCompliancePackaging)
                }
                "Pharmacy Multi-Drug Patient Compliance Packaging" => {
                    Some(PharmacyMultiDrugPatientCompliancePackaging)
                }
                "Remote Device Unit Dose" => Some(RemoteDeviceUnitDose),
                "Remote Device Multi-Drug Compliance" => {
                    Some(RemoteDeviceMultiDrugCompliance)
                }
                "Manufacturer Unit of Use Package (not unit dose)" => Some(CodeD),
