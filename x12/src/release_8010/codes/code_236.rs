...
pub enum PriceIdentifierCode {
    ...
    CodeD03,
    ///DAA - Distributor Cost
    DistributorCost,
    ///DAB - Distributor Cost Price Break 1
    DistributorCostPriceBreak1,
    ///DAC - Distributor Cost Price Break 2
    DistributorCostPriceBreak2,
    ///DAD - Distributor Cost Price Break 3
    DistributorCostPriceBreak3,
    ///DAE - Distributor Cost Price Break 4
    DistributorCostPriceBreak4,
    ///DAF - Distributor Cost Price Break 5
    DistributorCostPriceBreak5,
    ...
    ///MIP - Minimum Internet Advertised Price
    MinimumInternetAdvertisedPrice,
    ///MNC - Minimum Charge
    MinimumCharge,
    ...
    ///PAA - Price Group Code 1
    PriceGroupCode1,
    ///PAB - Price Group Code 2
    PriceGroupCode2,
    ///PAC - Price Group Code 3
    PriceGroupCode3,
    ///PAD - Business Report Group Code 1
    BusinessReportGroupCode1,
    ///PAE - Business Report Group Code 2
    BusinessReportGroupCode2,
    ///PAF - Business Report Group Code 3
    BusinessReportGroupCode3,
    ///PAG - Seller Class Code
    SellerClassCode,
    ///PAH - Seller Sub-Class Code
    SellerSubClassCode,
    ...
    ///QTE - Quote Price
    QuotePrice,
    ///RAA - Suggested Resale Price
    SuggestedResalePrice,
    ///RAB - Suggested Resale Price Break 1
    SuggestedResalePriceBreak1,
    ///RAC - Suggested Resale Price Break 2
    SuggestedResalePriceBreak2,
    ///RAD - Suggested Resale Price Break 3
    SuggestedResalePriceBreak3,
    ///RAE - Suggested Resale Price Break 4
    SuggestedResalePriceBreak4,
    ///RAF - Suggested Resale Price Break 5
    SuggestedResalePriceBreak5,
    ///REG - Regular Charge
    RegularCharge,
    ///RES - Resale
    Resale,
...
impl PriceIdentifierCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                CodeD03 => "D03",
                DistributorCost => "DAA",
                DistributorCostPriceBreak1 => "DAB",
                DistributorCostPriceBreak2 => "DAC",
                DistributorCostPriceBreak3 => "DAD",
                DistributorCostPriceBreak4 => "DAE",
                DistributorCostPriceBreak5 => "DAF",
                ...
                MinimumInternetAdvertisedPrice => "MIP",
                MinimumCharge => "MNC",
                ...
                PriceGroupCode2 => "PAB",
                PriceGroupCode3 => "PAC",
                BusinessReportGroupCode1 => "PAD",
                BusinessReportGroupCode2 => "PAE",
                BusinessReportGroupCode3 => "PAF",
                SellerClassCode => "PAG",
                SellerSubClassCode => "PAH",
                ...
                Purchase => "PUR",
                QuotePrice => "QTE",
                SuggestedResalePrice => "RAA",
                SuggestedResalePriceBreak1 => "RAB",
                SuggestedResalePriceBreak2 => "RAC",
                SuggestedResalePriceBreak3 => "RAD",
                SuggestedResalePriceBreak4 => "RAE",
                SuggestedResalePriceBreak5 => "RAF",
                RegularCharge => "REG",
                Resale => "RES",
                CodeRPA => "RPA",
                CodeRPM => "RPM",
    ...
    pub fn from_code(code: &[u8]) -> Option<PriceIdentifierCode> {
        ...
        match code {
            ...
            b"D03" => Some(CodeD03),
            b"DAA" => Some(DistributorCost),
            b"DAB" => Some(DistributorCostPriceBreak1),
            b"DAC" => Some(DistributorCostPriceBreak2),
            b"DAD" => Some(DistributorCostPriceBreak3),
            b"DAE" => Some(DistributorCostPriceBreak4),
            b"DAF" => Some(DistributorCostPriceBreak5),
            b"DAP" => Some(DealerAdjustedPrice),
            b"DEP" => Some(DepositAmount),
            ...
            b"MAA" => Some(MinimumAdvertisedPrice),
            b"MAC" => Some(MovingAverageCost),
            ...
            b"MIP" => Some(MinimumInternetAdvertisedPrice),
            ...
            b"PAA" => Some(PriceGroupCode1),
            b"PAB" => Some(PriceGroupCode2),
            b"PAC" => Some(PriceGroupCode3),
            b"PAD" => Some(BusinessReportGroupCode1),
            b"PAE" => Some(BusinessReportGroupCode2),
            b"PAF" => Some(BusinessReportGroupCode3),
            b"PAG" => Some(SellerClassCode),
            b"PAH" => Some(SellerSubClassCode),
            ...
            b"RAA" => Some(SuggestedResalePrice),
            b"RAB" => Some(SuggestedResalePriceBreak1),
            b"RAC" => Some(SuggestedResalePriceBreak2),
            b"RAD" => Some(SuggestedResalePriceBreak3),
            b"RAE" => Some(SuggestedResalePriceBreak4),
            b"RAF" => Some(SuggestedResalePriceBreak5),
    ...
    fn description(&self) -> &str {
        use PriceIdentifierCode::*;
        match self {
            AllowedAmountFlat => "Allowed Amount - Flat",
            Actual => "Actual",
            ...
            DistributorCostPriceBreak1 => "Distributor Cost Price Break 1",
            DistributorCostPriceBreak2 => "Distributor Cost Price Break 2",
            DistributorCostPriceBreak3 => "Distributor Cost Price Break 3",
            DistributorCostPriceBreak4 => "Distributor Cost Price Break 4",
            DistributorCostPriceBreak5 => "Distributor Cost Price Break 5",
            ...
            MinimumAdvertisedPrice => "Minimum Advertised Price",
            ...
            MinimumInternetAdvertisedPrice => "Minimum Internet Advertised Price",
            ...
            PriceGroupCode1 => "Price Group Code 1",
            PriceGroupCode2 => "Price Group Code 2",
            PriceGroupCode3 => "Price Group Code 3",
            BusinessReportGroupCode1 => "Business Report Group Code 1",
            BusinessReportGroupCode2 => "Business Report Group Code 2",
            BusinessReportGroupCode3 => "Business Report Group Code 3",
            SellerClassCode => "Seller Class Code",
            SellerSubClassCode => "Seller Sub-Class Code",
            ...
            SuggestedResalePrice => "Suggested Resale Price",
            SuggestedResalePriceBreak1 => "Suggested Resale Price Break 1",
            SuggestedResalePriceBreak2 => "Suggested Resale Price Break 2",
            SuggestedResalePriceBreak3 => "Suggested Resale Price Break 3",
            SuggestedResalePriceBreak4 => "Suggested Resale Price Break 4",
            SuggestedResalePriceBreak5 => "Suggested Resale Price Break 5",
            ...
            Transfer => "Transfer",
            UnitAllowedAmount => "Unit Allowed Amount",
    ...
    fn from_description(description: &str) -> Option<PriceIdentifierCode> {
        {
            use PriceIdentifierCode::*;
            match description {
                "Allowed Amount - Flat" => Some(AllowedAmountFlat),
                "Actual" => Some(Actual),
                ...
                "Distributor Cost" => Some(DistributorCost),
                "Distributor Cost Price Break 1" => Some(DistributorCostPriceBreak1),
                "Distributor Cost Price Break 2" => Some(DistributorCostPriceBreak2),
                "Distributor Cost Price Break 3" => Some(DistributorCostPriceBreak3),
                "Distributor Cost Price Break 4" => Some(DistributorCostPriceBreak4),
                "Distributor Cost Price Break 5" => Some(DistributorCostPriceBreak5),
                "Dealer Adjusted Price" => Some(DealerAdjustedPrice),
                "Deposit Amount" => Some(DepositAmount),
                ...
                "Minimum Advertised Price" => Some(MinimumAdvertisedPrice),
                "Moving Average Cost" => Some(MovingAverageCost),
                ...
                "Minimum Internet Advertised Price" => {
                    Some(MinimumInternetAdvertisedPrice)
                }
                ...
                "Price Group Code 1" => Some(PriceGroupCode1),
                "Price Group Code 2" => Some(PriceGroupCode2),
                "Price Group Code 3" => Some(PriceGroupCode3),
                "Business Report Group Code 1" => Some(BusinessReportGroupCode1),
                "Business Report Group Code 2" => Some(BusinessReportGroupCode2),
                "Business Report Group Code 3" => Some(BusinessReportGroupCode3),
                "Seller Class Code" => Some(SellerClassCode),
                "Seller Sub-Class Code" => Some(SellerSubClassCode),
                ...
                "Suggested Resale Price" => Some(SuggestedResalePrice),
                "Suggested Resale Price Break 1" => Some(SuggestedResalePriceBreak1),
                "Suggested Resale Price Break 2" => Some(SuggestedResalePriceBreak2),
                "Suggested Resale Price Break 3" => Some(SuggestedResalePriceBreak3),
                "Suggested Resale Price Break 4" => Some(SuggestedResalePriceBreak4),
                "Suggested Resale Price Break 5" => Some(SuggestedResalePriceBreak5),
                ...
                "Unit Allowed Amount" => Some(UnitAllowedAmount),
