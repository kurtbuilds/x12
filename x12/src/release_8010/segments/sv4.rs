...
Code indicating that the pharmacist is clarifying the submission*/
    pub submission_clarification_code: Option<String>,
    /**SV4-20 (1735)
Code indicating whether or not the patient has other insurance coverage*/
    pub additional_drug_coverage_code: Option<String>,
    /**SV4-21 (1736)
Code indicating the route of administration of the complete compound mixture*/
    pub compound_route_of_administration_code: Option<String>,
    /**SV4-22 (1737)
Code indicating the basis for percentage tax*/
    pub submitted_drug_tax_code: Option<Fixed<2>>,
    /**SV4-23 (954)
