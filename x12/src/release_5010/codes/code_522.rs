...
pub enum AmountQualifierCode {
    ...
    PayorResponsibilityEstimated,
    ///C8 - Payor Responsibility - Actual
    PayorResponsibilityActual,
...
impl AmountQualifierCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                PayorResponsibilityEstimated => "C7",
                PayorResponsibilityActual => "C8",
    ...
    pub fn from_code(code: &[u8]) -> Option<AmountQualifierCode> {
        ...
        match code {
            ...
            b"C7" => Some(PayorResponsibilityEstimated),
            b"C8" => Some(PayorResponsibilityActual),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            PayorResponsibilityEstimated => "Payor Responsibility - Estimated",
            PayorResponsibilityActual => "Payor Responsibility - Actual",
            ...
            PayorAmountPaid => "Payor Amount Paid",
    ...
    fn from_description(description: &str) -> Option<AmountQualifierCode> {
        {
            ...
            match description {
                ...
                "Payor Responsibility - Estimated" => Some(PayorResponsibilityEstimated),
                "Payor Responsibility - Actual" => Some(PayorResponsibilityActual),
                ...
                "Payor Amount Paid" => Some(PayorAmountPaid),
