...
See docs at <https://www.stedi.com/edi/x12-005010/element/1270>*/
...
pub enum CodeListQualifierCode {
    ...
    HealthCareFinancingAdministrationCommonProceduralCodingSystemPrincipalProcedure,
...
impl CodeListQualifierCode {
    pub fn code(&self) -> &str {
        {
            ...
            match self {
                ...
                CodeBN => "BN",
                HealthCareFinancingAdministrationCommonProceduralCodingSystem => "BO",
                HealthCareFinancingAdministrationCommonProceduralCodingSystemPrincipalProcedure => {
                    "BP"
                }
                ...
                NationalCouncilForPrescriptionDrugProgramsRejectPaymentCodes => "RX",
                CodeS => "S",
    ...
    pub fn from_code(code: &[u8]) -> Option<CodeListQualifierCode> {
        ...
        match code {
            ...
            b"BN" => Some(CodeBN),
            b"BO" => Some(HealthCareFinancingAdministrationCommonProceduralCodingSystem),
            b"BP" => {
                Some(
                    HealthCareFinancingAdministrationCommonProceduralCodingSystemPrincipalProcedure,
                )
            ...
            b"HE" => Some(ClaimPaymentRemarkCodes),
            ...
            b"RX" => Some(NationalCouncilForPrescriptionDrugProgramsRejectPaymentCodes),
            b"S" => Some(CodeS),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            ClaimPaymentRemarkCodes => "Claim Payment Remark Codes",
            ...
            CodeHO => "Home Infusion EDI Coalition (HIEC) Product/Service Code",
    ...
    fn from_description(description: &str) -> Option<CodeListQualifierCode> {
        {
            ...
            match description {
                ...
                "Health Care Financing Administration Common Procedural Coding System" => {
                    Some(HealthCareFinancingAdministrationCommonProceduralCodingSystem)
                }
                "Health Care Financing Administration Common Procedural Coding System Principal Procedure" => {
                    Some(
                        HealthCareFinancingAdministrationCommonProceduralCodingSystemPrincipalProcedure,
                ...
                "Claim Payment Remark Codes" => Some(ClaimPaymentRemarkCodes),
                ...
                "Home Infusion EDI Coalition (HIEC) Product/Service Code" => Some(CodeHO),
                ...
                "National Council for Prescription Drug Programs Reject/Payment Codes" => {
                    Some(NationalCouncilForPrescriptionDrugProgramsRejectPaymentCodes)
                }
                "Society for Worldwide Interbank Financial Telecommunications (SWIFT)" => {
                    Some(CodeS)
                }
