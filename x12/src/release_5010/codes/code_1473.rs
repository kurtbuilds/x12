...
See docs at <https://www.stedi.com/edi/x12-005010/element/1473>*/
#[derive(Debug, Clone, Copy, PartialEq)]
pub enum PricingMethodology {
...
impl PricingMethodology {
    pub fn code(&self) -> &str {
        {
            use PricingMethodology::*;
            match self {
                Code00 => "00",
                Code01 => "01",
    ...
    pub fn from_code(code: &[u8]) -> Option<PricingMethodology> {
        use PricingMethodology::*;
        match code {
            b"00" => Some(Code00),
            b"01" => Some(Code01),
    ...
    fn from_description(description: &str) -> Option<PricingMethodology> {
        {
            use PricingMethodology::*;
            match description {
...
impl Serialize for PricingMethodology {
...
impl<'de> de::Visitor<'de> for Visitor {
    type Value = PricingMethodology;
    fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        formatter.write_str("Pricing Methodology")
    }
    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E>
    where
        E: de::Error,
    {
        PricingMethodology::from_description(v)
            .ok_or_else(|| E::custom(format!("Invalid Pricing Methodology: {}", v)))
    }
    fn visit_bytes<E>(self, v: &[u8]) -> Result<Self::Value, E>
    where
        E: de::Error,
    {
        PricingMethodology::from_code(v)
            .ok_or_else(|| E::custom(
                format!(
                    "Invalid Pricing Methodology: {}", std::str::from_utf8(v).unwrap()
                ),
            ))
    }
}
impl<'de> Deserialize<'de> for PricingMethodology {
