...
See docs at <https://www.stedi.com/edi/x12-005010/element/640>*/
...
impl TransactionTypeCode {
    ...
    pub fn from_code(code: &[u8]) -> Option<TransactionTypeCode> {
        ...
        match code {
            ...
            b"AZ" => Some(DisposalShipmentAdvice),
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            DisposalShipmentAdvice => "Disposal Shipment Advice",
    ...
    fn from_description(description: &str) -> Option<TransactionTypeCode> {
        {
            ...
            match description {
                ...
                "Disposal Shipment Advice" => Some(DisposalShipmentAdvice),
