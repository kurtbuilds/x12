...
See docs at <https://www.stedi.com/edi/x12-005010/element/374>*/
...
impl DateTimeQualifier {
    ...
    fn description(&self) -> &str {
        ...
        match self {
            ...
            PlanToObsolete => "Plan to Obsolete",
    ...
    fn from_description(description: &str) -> Option<DateTimeQualifier> {
        {
            ...
            match description {
                ...
                "Plan to Obsolete" => Some(PlanToObsolete),
