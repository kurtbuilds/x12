...
use super::super::segments::PacemakerCertification;
...
use super::super::segments::MedicareOutpatientAdjudication;
...
use super::super::segments::MedicareInpatientAdjudication;
...
See full docs at <https://www.stedi.com/edi/x12-005010/transaction-set/837>*/
...
To supply information related to the certification of a home health care patient*/
    ...
    /**Pacemaker Certification (CR8)
To supply information related to Pacemaker registry*/
    pub pacemaker_certification: Vec<PacemakerCertification>,
...
To specify information associated with other health insurance coverage*/
    ...
    /**Medicare Inpatient Adjudication (MIA)
To provide claim-level data related to the adjudication of Medicare inpatient claims*/
    pub medicare_inpatient_adjudication: Option<MedicareInpatientAdjudication>,
...
To convey claim-level data related to the adjudication of Medicare claims not related to an inpatient setting*/
    pub medicare_outpatient_adjudication: Option<MedicareOutpatientAdjudication>,
    ///3250
